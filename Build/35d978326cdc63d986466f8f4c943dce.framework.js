...
var ASM_CONSTS = {
  4158320: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4158381: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4158445: function() {return Module.webglContextAttributes.powerPreference;},  
 4158503: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4158558: function($0) {performance.now = function() { return $0; };},  
 4158606: function($0) {performance.now = function() { return $0; };},  
 4158654: function() {performance.now = Module['emscripten_get_now_backup'];}
};
              ...
              var Bridge = ( function () {
                  ...
                  Bridge.prototype.onInitInstance = function ( iOnly, iName, iParam ) {
                      ...
                      if ( this._thinkingdata ) {
                          this._thinkingdata.initInstance( sName, JSON.parse( sParam ) );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                  ...
                  Bridge.prototype.onSetSuperProperties = function ( iOnly, iParam ) {
                      ...
                      var oObject;
                      if ( this._thinkingdata ) {
                          this._thinkingdata.setSuperProperties( JSON.parse( sParam ) );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                  ...
                  Bridge.prototype.onTrack = function ( iOnly, iEvent, iParam ) {
                      ...
                      if ( this._thinkingdata ) {
                          if ( sParam == "" ) {
                              ...
                              this._thinkingdata.track( sEvent, JSON.parse( sParam ) );
                          }
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                  ...
                  Bridge.prototype.onUserSet = function ( iOnly, iParam ) {
                      ...
                      var oObject;
                      if ( this._thinkingdata ) {
                          this._thinkingdata.userSet( JSON.parse( sParam ) );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                  ...
                  Bridge.prototype.onUserSetOnce = function ( iOnly, iParam ) {
                      ...
                      var oObject;
                      if ( this._thinkingdata ) {
                          this._thinkingdata.userSetOnce( JSON.parse( sParam ) );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                  ...
                  Bridge.prototype.onQuick = function ( iOnly, iQuick, iParam ) {
                      ...
                      if ( this._thinkingdata ) {
                          if ( sParam == "" ) {
                              ...
                              this._thinkingdata.quick( sQuick, JSON.parse( sParam ) );
                          }
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
  ...
  function _onTonAddress( iOnly ) {
          Reflect.get( window, "#unity.bridge.ton" ).onAddress( iOnly );
      }
  ...
  function _onTonInitial( iOnly, iName, iMethod, iUrl, iUnpkg, iManifest ) {
          if ( Reflect.has( window, "#unity.bridge.ton" ) ) {
              ...
              var Bridge = ( function () {
                  ...
                  Object.defineProperty( Bridge.prototype, "_TON_CONNECT_UI", {
                      get: function () {
                  ...
                  Bridge.prototype.onModalStateChange = function ( oState ) {
                      if ( oState.status == "closed" ) {
                          var aCallback_1 = new Array();
                          this._callback.forEach( function ( t ) {
                              return aCallback_1.push( t );
                          } );
                          do {
                              if ( aCallback_1.length ) {
                                  var _a = __read( aCallback_1.pop(), 2 ),
                                      oSuccess = _a[ 0 ],
                                      oFailure = _a[ 1 ];
                                  if ( this._wallet ) {
                                      oSuccess.apply( this );
                          ...
                          return __generator( this, function ( _b ) {
                              switch ( _b.label ) {
                                  ...
                                  case 5:
                                      ...
                                      this._tonConnectUI.onStatusChange( this.onStatusChange.bind( this ) );
                                      this._tonConnectUI.onModalStateChange( this.onModalStateChange.bind( this ) );
                                      return [ 4, this._tonConnectUI.connectionRestored ];
                                  case 6:
                                      _b.sent();
                                      oObject = {
                                          Only: sOnly,
                  ...
                  Bridge.prototype.onStatus = function ( iOnly ) {
                      ...
                      if ( this._tonConnectUI ) {
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: "".concat( this._tonConnectUI.connected )
                          };
                      } else {
                          oObject = {
                              Only: sOnly,
                  ...
                  Bridge.prototype.onAddress = function ( iOnly ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, oObject, oDivElement, _a;
                          var _this = this;
                          return __generator( this, function ( _b ) {
                              switch ( _b.label ) {
                                  case 0:
                                      sOnly = UTF8ToString( iOnly );
                                      if ( !this._tonConnectUI ) return [ 3, 7 ];
                                      if ( !( this._tonConnectUI.connected && this._wallet ) ) return [ 3, 1 ];
                                      oObject = {
                                          Only: sOnly,
                                          Type: "Success",
                                          Value: this._TON_CONNECT_UI.toUserFriendlyAddress( this._wallet.account.address )
                                      };
                                      return [ 3, 6 ];
                                  case 1:
                                      oDivElement = document.getElementById( "tc-widget-root" );
                                      oDivElement.style.display = "block";
                                      return [ 4, this._tonConnectUI.openModal() ];
                                  case 2:
                                      _b.sent();
                                      _b.label = 3;
                                  case 3:
                  ...
                  Bridge.prototype.onDisconnect = function ( iOnly ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, oObject, error_2;
                          return __generator( this, function ( _a ) {
                              switch ( _a.label ) {
                                  case 0:
                                      sOnly = UTF8ToString( iOnly );
                                      if ( !this._tonConnectUI ) return [ 3, 7 ];
                                      if ( !this._tonConnectUI.connected ) return [ 3, 5 ];
                                      _a.label = 1;
                                  case 1:
                                      _a.trys.push( [ 1, 3, , 4 ] );
                                      return [ 4, this._tonConnectUI.disconnect() ];
                                  case 2:
                                      _a.sent();
                                      oObject = {
                                          Only: sOnly,
                  ...
                  Bridge.prototype.onTransaction = function ( iOnly, iValidUntil, iValue ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, sValue, oObject, oResult, error_3;
                          return __generator( this, function ( _a ) {
                              switch ( _a.label ) {
                                  case 0:
                                      sOnly = UTF8ToString( iOnly );
                                  ...
                                  case 1:
                                      _a.trys.push( [ 1, 3, , 4 ] );
                                      return [ 4, this._tonConnectUI.sendTransaction( {
                                          validUntil: Math.floor( Date.now() / 1000 ) + iValidUntil,
                                          messages: JSON.parse( atob( sValue ) )
                                      }, {

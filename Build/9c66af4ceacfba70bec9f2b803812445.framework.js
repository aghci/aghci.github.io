...
var ASM_CONSTS = {
 ...
 4152270: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  async function _onSystemClipboard(iOnly, iValue) {
          let oUnityContainer = document.querySelector("#unity-container");
          oUnityContainer.style.display = "none";
          ...
          setTimeout(() => oUnityContainer.style.display = "block", 10000);
          ...
          if (window.integration_system) {
              ...
              window.integration_system = {
                  ...
                  clipboard1: (oElement, sValue) => new Promise((resolve, reject) => {
                      ...
                      oButtonElement.dispatchEvent(new MouseEvent('click', {
                          view: window,
                          bubbles: true,
                          cancelable: true,
                          clientX: iClientX,

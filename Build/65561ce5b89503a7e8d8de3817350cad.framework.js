 ...
 4149598: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  function _onTelegramInitial( iOnly, iName, iMethod, iUnpkg ) {
          ...
          if ( window.integration_telegram ) {
              ...
              let oPropagation = ( t ) => t.stopPropagation();
  
              document.addEventListener( "touchstart", oPropagation, oOptions );
  
              document.addEventListener( "touchmove", oPropagation, oOptions );
  
              document.addEventListener( "touchend", oPropagation, oOptions );
  
              document.addEventListener( "touchcancel", oPropagation, oOptions );

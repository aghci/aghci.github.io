 ...
 4150078: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  function _onTelegramInitial(iOnly, iName, iMethod, iUnpkg) {
          ...
          if (window.integration_telegram) {
              ...
              oStyleElement.textContent = `body { width: 100%; height: 500vh; overflow: hidden auto; padding: 0px; margin: 0px;}`;
              oScriptElement.src = sUnpkg;
              oScriptElement.addEventListener("load", window.integration_telegram.load);
  ...
  function _onTelegramOpenLink(iOnly, iUrl, isTryInstantView) {
          ...
          let oObject;
          try {
              window.Telegram.WebApp.openLink(sUrl, { try_instant_view: isTryInstantView });
              oObject = {
                  Only: sOnly,
                  Type: "Success",
                  Value: ""
  ...
  function _onTonInitial(iOnly, iName, iMethod, iUrl, iUnpkg, iManifest) {
          ...
          if (window.integration_ton) {
              ...
              oStyleElement.textContent = `#Ton {position: fixed; top: 0; right: 0; left: 0; bottom: 0;}`;
              oDivElement.id = "Ton";

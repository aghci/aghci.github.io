...
var ASM_CONSTS = {
  4158976: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4159037: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4159101: function() {return Module.webglContextAttributes.powerPreference;},  
 4159159: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4159214: function($0) {performance.now = function() { return $0; };},  
 4159262: function($0) {performance.now = function() { return $0; };},  
 4159310: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _onSystemClipboard(iOnly, iValue) {
          Reflect.get(window, "_UnitySystem").onSystemClipboard(iOnly, iValue);
      }

  function _onSystemInitial(iOnly, iName, iMethod) {
          if (Reflect.has(window, "_UnitySystem")) {
              ...
              var UnitySystem = (function () {
                  function UnitySystem(iName, iMethod) {
                      this._name = UTF8ToString(iName);
                      this._method = UTF8ToString(iMethod);
                  }
                  UnitySystem.prototype.onReply = function (oObject) {
                      SendMessage(this._name, this._method, JSON.stringify(oObject));
                  };
                  UnitySystem.prototype.onAwait = function () {
                      return new Promise(function (resolve) { return requestAnimationFrame ? requestAnimationFrame(function () { return resolve(); }) : setTimeout(resolve, 0); });
                  };
                  UnitySystem.prototype.onClipboard = function (sValue) {
                  ...
                  UnitySystem.prototype.onLoad = function (resolve, reject) {
                      var oHeadElement = document.querySelector("head");
                      var oScriptElement = document.createElement("script");
                      oScriptElement.src = "https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.11/clipboard.min.js";
                      oScriptElement.addEventListener("load", function () { return resolve(); }, false);
                      oScriptElement.addEventListener("error", function () { return reject(); }, false);
                      oHeadElement.appendChild(oScriptElement);
                  };
                  UnitySystem.prototype.onSystemInitial = function (iOnly) {
                      return __awaiter(this, void 0, void 0, function () {
                          var sOnly, oObject, _a;
                          var _this = this;
                          return __generator(this, function (_b) {
                              switch (_b.label) {
                                  case 0:
                                  ...
                                  case 1:
                                      _b.trys.push([1, 3, , 4]);
                                      return [4, new Promise(function (resolve, reject) { return _this.onLoad(resolve, reject); })];
                                  case 2:
                                      _b.sent();
                                      oObject = {
                                          Only: sOnly,
                  ...
                  UnitySystem.prototype.onSystemVisibility = function (iOnly, iName, iMethod) {
                  ...
                  UnitySystem.prototype.onSystemClipboard = function (iOnly, iValue) {
                      return __awaiter(this, void 0, void 0, function () {
                          var sOnly, sValue, oObject;
                          return __generator(this, function (_a) {
                              switch (_a.label) {
                                  ...
                                  case 1:
                                      _a.sent();
                                      return [4, this.onClipboard(sValue)];
                                  case 2:
                                      if (_a.sent()) {
                                          oObject = {
                                              Only: sOnly,
                  ...
                  UnitySystem.prototype.onSystemPrompt = function (iOnly, iTitle, iValue) {
                      var sOnly = UTF8ToString(iOnly);
              ...
              var oUnitySystem = new UnitySystem(iName, iMethod);
              oUnitySystem.onSystemInitial(iOnly);
              Reflect.set(window, "_UnitySystem", oUnitySystem);
          }
      }

  function _onSystemPrompt(iOnly, iTitle, iValue) {
          Reflect.get(window, "_UnitySystem").onSystemPrompt(iOnly, iTitle, iValue);
      }

  function _onSystemVisibility(iOnly, iName, iMethod) {
          Reflect.get(window, "_UnitySystem").onSystemVisibility(iOnly, iName, iMethod);
      }

  function _onTelegramDisableClosingConfirmation(iOnly) {
          Reflect.get(window, "_UnityTelegram").onTelegramDisableClosingConfirmation(iOnly);
      }

  function _onTelegramEnableClosingConfirmation(iOnly) {
          Reflect.get(window, "_UnityTelegram").onTelegramEnableClosingConfirmation(iOnly);
      }

  function _onTelegramExpand(iOnly) {
          Reflect.get(window, "_UnityTelegram").onTelegramExpand(iOnly);
      }

  function _onTelegramInitData(iOnly) {
          Reflect.get(window, "_UnityTelegram").onTelegramInitData(iOnly);
      }

  function _onTelegramInitial(iOnly, iName, iMethod, iUnpkg) {
          if (Reflect.has(window, "_UnityTelegram")) {
              SendMessage(UTF8ToString(iName), UTF8ToString(iMethod), JSON.stringify({
                  Only: UTF8ToString(iOnly),
                  Type: "Failure",
              ...
              var UnityTelegram = (function () {
                  function UnityTelegram(iName, iMethod) {
                      this._name = UTF8ToString(iName);
                      this._method = UTF8ToString(iMethod);
                  }
                  Object.defineProperty(UnityTelegram.prototype, "_telegram", {
                      get: function () {
                  ...
                  Object.defineProperty(UnityTelegram.prototype, "_webApp", {
                      get: function () {
                  ...
                  UnityTelegram.prototype.onReply = function (oObject) {
                      SendMessage(this._name, this._method, JSON.stringify(oObject));
                  };
                  UnityTelegram.prototype.onLoad = function (sUnpkg, resolve, reject) {
                      var oHeadElement = document.querySelector("head");
                      var oScriptElement = document.createElement("script");
                  ...
                  UnityTelegram.prototype.openInvoice = function (sUrl, resolve, reject) {
                      try {
                  ...
                  UnityTelegram.prototype.onTelegramInitial = function (iOnly, iUnpkg) {
                      return __awaiter(this, void 0, void 0, function () {
                          var sOnly, sUnpkg, oObject, oHeadElement, oStyleElement, _a;
                          var _this = this;
                          return __generator(this, function (_b) {
                              switch (_b.label) {
                                  case 0:
                                  ...
                                  case 1:
                                      _b.trys.push([1, 3, , 4]);
                                      return [4, new Promise(function (resolve, reject) { return _this.onLoad(sUnpkg, resolve, reject); })];
                                  case 2:
                                      _b.sent();
                                  ...
                                  case 5:
                                      this.onScrollTo();
                                      return [4, new Promise(function (oResolve) { return setTimeout(oResolve, 1000); })];
                                  case 6:
                                      _b.sent();
                                      _b.label = 7;
                                  case 7:
                  ...
                  UnityTelegram.prototype.onTelegramInitData = function (iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                          oObject = {
                  ...
                  UnityTelegram.prototype.onTelegramStartApp = function (iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                          oObject = {
                  ...
                  UnityTelegram.prototype.onTelegramUser = function (iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                  ...
                  UnityTelegram.prototype.onTelegramReceiver = function (iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                  ...
                  UnityTelegram.prototype.onTelegramExpand = function (iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                          this._webApp.expand();
                  ...
                  UnityTelegram.prototype.onTelegramEnableClosingConfirmation = function (iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                  ...
                  UnityTelegram.prototype.onTelegramDisableClosingConfirmation = function (iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                  ...
                  UnityTelegram.prototype.onTelegramOpenLink = function (iOnly, iUrl, isTryInstantView) {
                      var sOnly = UTF8ToString(iOnly);
                      var sUrl = UTF8ToString(iUrl);
                      var oObject;
                      try {
                          this._webApp.openLink(sUrl, { try_instant_view: isTryInstantView });
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: ""
                  ...
                  UnityTelegram.prototype.onTelegramOpenTelegramLink = function (iOnly, iUrl) {
                      var sOnly = UTF8ToString(iOnly);
                      var sUrl = UTF8ToString(iUrl);
                      var oObject;
                      try {
                  ...
                  UnityTelegram.prototype.onTelegramOpenInvoice = function (iOnly, iUrl) {
                      return __awaiter(this, void 0, void 0, function () {
                          ...
                          return __generator(this, function (_a) {
                              switch (_a.label) {
                                  ...
                                  case 1:
                                      _a.trys.push([1, 3, , 4]);
                                      return [4, new Promise(function (resolve, reject) { return _this.openInvoice(sUrl, resolve, reject); })];
                                  case 2:
                                      sValue = _a.sent();
                                      oObject = {
                                          Only: sOnly,
                  ...
                  UnityTelegram.prototype.onScrollTo = function () {
                      var iTop = 0;
                  ...
                  return UnityTelegram;
              }());
              var oUnityTelegram = new UnityTelegram(iName, iMethod);
              oUnityTelegram.onTelegramInitial(iOnly, iUnpkg);
              Reflect.set(window, "_UnityTelegram", oUnityTelegram);
          }
      }

  function _onTelegramOpenInvoice(iOnly, iUrl) {
          Reflect.get(window, "_UnityTelegram").onTelegramOpenInvoice(iOnly, iUrl);
      }

  function _onTelegramOpenLink(iOnly, iUrl, isTryInstantView) {
          Reflect.get(window, "_UnityTelegram").onTelegramOpenLink(iOnly, iUrl, isTryInstantView);
      }

  function _onTelegramOpenTelegramLink(iOnly, iUrl) {
          Reflect.get(window, "_UnityTelegram").onTelegramOpenTelegramLink(iOnly, iUrl);
      }

  function _onTelegramStartApp(iOnly) {
          Reflect.get(window, "_UnityTelegram").onTelegramStartApp(iOnly);
      }

  function _onTelegramUser(iOnly) {
          Reflect.get(window, "_UnityTelegram").onTelegramUser(iOnly);
      }

  function _onThinkingInitial(iOnly, iName, iMethod, iScript, iAppId, iServerUrl, isPageShow, isPageHide) {
          if (Reflect.has(window, "_UnityThinking")) {
              SendMessage(UTF8ToString(iName), UTF8ToString(iMethod), JSON.stringify({
                  Only: UTF8ToString(iOnly),
                  Type: "Failure",
                  Value: "Telegram has been initial"
              ...
              var UnityThinking = (function () {
                  function UnityThinking(iName, iMethod) {
                      this._name = UTF8ToString(iName);
                      this._method = UTF8ToString(iMethod);
                  }
                  Object.defineProperty(UnityThinking.prototype, "_thinkingdata", {
                      get: function () {
                  ...
                  UnityThinking.prototype.onReply = function (oObject) {
                      SendMessage(this._name, this._method, JSON.stringify(oObject));
                  };
                  UnityThinking.prototype.onLoad = function (sScript, resolve, reject) {
                      var oHeadElement = document.querySelector("head");
                      var oScriptElement = document.createElement("script");
                      ...
                      oScriptElement.addEventListener("error", function () { return reject(); }, false);
                      oHeadElement.appendChild(oScriptElement);
                      oScriptElement.dispatchEvent(new Event('load'));
                  };
                  UnityThinking.prototype.onThinkingInitial = function (iOnly, iScript, iAppId, iServerUrl, isPageShow, isPageHide) {
                      return __awaiter(this, void 0, void 0, function () {
                          ...
                          return __generator(this, function (_b) {
                              switch (_b.label) {
                                  ...
                                  case 1:
                                      _b.trys.push([1, 3, , 4]);
                                      return [4, new Promise(function (resolve, reject) { return _this.onLoad(sScript, resolve, reject); })];
                                  case 2:
                                      _b.sent();
                  ...
                  UnityThinking.prototype.onThinkingInitInstance = function (iOnly, iName, iParam) {
                      var sOnly = UTF8ToString(iOnly);
                      var sName = UTF8ToString(iName);
                  ...
                  UnityThinking.prototype.onThinkingLogin = function (iOnly, iAccountId) {
                      var sOnly = UTF8ToString(iOnly);
                  ...
                  UnityThinking.prototype.onThinkingSetSuperProperties = function (iOnly, iParam) {
                      var sOnly = UTF8ToString(iOnly);
                      var sParam = UTF8ToString(iParam);
                      var oObject;
                      if (this._thinkingdata) {
                  ...
                  UnityThinking.prototype.onThinkingTrack = function (iOnly, iEvent, iParam) {
                      var sOnly = UTF8ToString(iOnly);
                  ...
                  UnityThinking.prototype.onThinkingUserSet = function (iOnly, iParam) {
                      var sOnly = UTF8ToString(iOnly);
                      var sParam = UTF8ToString(iParam);
                      var oObject;
                      if (this._thinkingdata) {
                  ...
                  UnityThinking.prototype.onThinkingUserSetOnce = function (iOnly, iParam) {
                      var sOnly = UTF8ToString(iOnly);
                      var sParam = UTF8ToString(iParam);
                      var oObject;
                      if (this._thinkingdata) {
                  ...
                  UnityThinking.prototype.onThinkingQuick = function (iOnly, iQuick, iParam) {
                      var sOnly = UTF8ToString(iOnly);
                  ...
                  return UnityThinking;
              }());
              var oUnityThinking = new UnityThinking(iName, iMethod);
              oUnityThinking.onThinkingInitial(iOnly, iScript, iAppId, iServerUrl, isPageShow, isPageHide);
              Reflect.set(window, "_UnityThinking", oUnityThinking);
          }
      }

  function _onThinkingLogin(iOnly, iAccountId) {
          Reflect.get(window, "_UnityThinking").onThinkingLogin(iOnly, iAccountId);
      }

  function _onThinkingQuick(iOnly, iQuick, iParam) {
          Reflect.get(window, "_UnityThinking").onThinkingQuick(iOnly, iQuick, iParam);
      }

  function _onThinkingTrack(iOnly, iEvent, iParam) {
          Reflect.get(window, "_UnityThinking").onThinkingTrack(iOnly, iEvent, iParam);
      }

  function _onThinkingUserSet(iOnly, iParam) {
          Reflect.get(window, "_UnityThinking").onThinkingUserSet(iOnly, iParam);
      }

  function _onThinkingUserSetOnce(iOnly, iParam) {
          Reflect.get(window, "_UnityThinking").onThinkingUserSetOnce(iOnly, iParam);
      }

  function _onTonAddress(iOnly) {
          Reflect.get(window, "_UnityTon").onTonAddress(iOnly);
      }

  function _onTonDisconnect(iOnly) {
          Reflect.get(window, "_UnityTon").onTonDisconnect(iOnly);
      }

  function _onTonInitial(iOnly, iName, iMethod, iUrl, iUnpkg, iManifest) {
          if (Reflect.has(window, "_UnityTon")) {
              SendMessage(UTF8ToString(iName), UTF8ToString(iMethod), JSON.stringify({
                  Only: UTF8ToString(iOnly),
                  Type: "Failure",
                  Value: "Telegram has been initial"
              ...
              var UnityTon = (function () {
                  function UnityTon(iName, iMethod, iUrl) {
                      this._name = UTF8ToString(iName);
                      this._method = UTF8ToString(iMethod);
                      this._url = UTF8ToString(iUrl);
                      this._callback = new Array();
                  }
                  Object.defineProperty(UnityTon.prototype, "_TON_CONNECT_UI", {
                      get: function () {
                  ...
                  UnityTon.prototype.onReply = function (oObject) {
                      SendMessage(this._name, this._method, JSON.stringify(oObject));
                  };
                  UnityTon.prototype.onStatusChange = function (oWallet) {
                      this._wallet = oWallet;
                  };
                  UnityTon.prototype.onModalStateChange = function (oState) {
                      if (oState.status == "closed") {
                          var aCallback_1 = new Array();
                          this._callback.forEach(function (t) { return aCallback_1.push(t); });
                          do {
                              if (aCallback_1.length) {
                                  var _a = aCallback_1.pop(), oSuccess = _a[0], oFailure = _a[1];
                                  if (this._wallet) {
                                      oSuccess.apply(this);
                                  }
                                  else {
                  ...
                  UnityTon.prototype.onLoad = function (sUnpkg, resolve, reject) {
                      var oHeadElement = document.querySelector("head");
                      var oScriptElement = document.createElement("script");
                      oScriptElement.src = sUnpkg;
                      oScriptElement.addEventListener("load", function () { return resolve(); }, false);
                  ...
                  UnityTon.prototype.onTonInitial = function (iOnly, iUnpkg, iManifest) {
                      return __awaiter(this, void 0, void 0, function () {
                          var sOnly, sUnpkg, sManifest, oObject, oRegex1, oRegex2, oRegex3, oRegex4, error_1;
                          var _this = this;
                          return __generator(this, function (_a) {
                              switch (_a.label) {
                                  case 0:
                                  ...
                                  case 2:
                                      ...
                                      this._tonConnectUI.onStatusChange(this.onStatusChange);
                                      this._tonConnectUI.onModalStateChange(this.onModalStateChange);
                  ...
                  UnityTon.prototype.onTonStatus = function (iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                  ...
                  UnityTon.prototype.onTonAddress = function (iOnly) {
                      return __awaiter(this, void 0, void 0, function () {
                          ...
                          return __generator(this, function (_b) {
                              switch (_b.label) {
                                  ...
                                  case 3:
                                      _b.trys.push([3, 5, , 6]);
                                      return [4, new Promise(function (resolve, reject) { return _this._callback.push([resolve, reject]); })];
                                  case 4:
                                      _b.sent();
                                      oObject = {
                                          Only: sOnly,
                  ...
                  UnityTon.prototype.onTonDisconnect = function (iOnly) {
                      return __awaiter(this, void 0, void 0, function () {
                  ...
                  UnityTon.prototype.onTonTransaction = function (iOnly, iValidUntil, iValue) {
                      return __awaiter(this, void 0, void 0, function () {
              ...
              var oUnityTon = new UnityTon(iName, iMethod, iUrl);
              oUnityTon.onTonInitial(iOnly, iUnpkg, iManifest);
              Reflect.set(window, "_UnityTon", oUnityTon);
          }
      }

  function _onTonStatus(iOnly) {
          Reflect.get(window, "_UnityTon").onTonStatus(iOnly);
      }

  function _onTonTransaction(iOnly, iValidUntil, iValue) {
          Reflect.get(window, "_UnityTon").onTonTransaction(iOnly, iValidUntil, iValue);
      }

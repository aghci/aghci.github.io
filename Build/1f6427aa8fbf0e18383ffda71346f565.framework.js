  ...
  function _onTelegramInitial( iOnly, iName, iMethod, iUnpkg ) {
          ...
          if ( window.integration_telegram ) {
              ...
              oScriptElement.addEventListener( "load", async () => {
                  ...
                  document.documentElement.style.setProperty( "--telegram-top", isPhone ? `${ ( document.documentElement.scrollHeight || document.body.scrollHeight ) - window.innerHeight }px` : "0px" );
                  oObject.ready();
                  oObject.reply( {
                      Only: sOnly,
                      Type: "Success",

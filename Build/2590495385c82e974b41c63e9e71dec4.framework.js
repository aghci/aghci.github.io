          ...
          if ( Reflect.has( window, "#unity.bridge.telegram" ) ) {
              ...
              var Bridge = ( function () {
                  ...
                  Bridge.prototype.onUser = function ( iOnly ) {
                      ...
                      var oObject;
                      try {
                          if ( this._webApp.initDataUnsafe.user ) {
                              oObject = {
                                  Only: sOnly,
                                  Type: "Success",
                                  Value: JSON.stringify( this._webApp.initDataUnsafe.user )
                              };
                          } else {
                              oObject = {
                                  Only: sOnly,
                  ...
                  Bridge.prototype.onReceiver = function ( iOnly ) {
                      ...
                      var oObject;
                      try {
                          if ( this._webApp.initDataUnsafe.receiver ) {
                              oObject = {
                                  Only: sOnly,
                                  Type: "Success",
                                  Value: JSON.stringify( this._webApp.initDataUnsafe.receiver )
                              };
                          } else {
                              oObject = {
                                  Only: sOnly,

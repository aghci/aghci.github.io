 ...
 4150078: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  function _onTelegramInitial( iOnly, iName, iMethod, iUnpkg ) {
          ...
          if ( window.integration_telegram ) {
              ...
              window.integration_telegram.scroll();
              window.addEventListener( "scroll", window.integration_telegram.scroll, { passive: false } );
              let oHeadElement = document.querySelector( "head" );
              let oBodyElement = document.querySelector( "body" );
  
              let oDivElement = document.createElement( "div" );
              oDivElement.style.width = "100%";
              oDivElement.style.height = "500vh";
              oDivElement.style.overflow = "hidden auto";
              oDivElement.style.padding = "0";
              oDivElement.style.margin = "0";
  
              oBodyElement.appendChild( oDivElement );
  
              let oScriptElement = document.createElement( "script" );
              oScriptElement.src = sUnpkg;
              oScriptElement.addEventListener( "load", window.integration_telegram.load, { passive: false } );
              oHeadElement.appendChild( oScriptElement );
          }
      }

 ...
 4150078: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  function _onTelegramInitial(iOnly, iName, iMethod, iUnpkg) {
          ...
          if (window.integration_telegram) {
              ...
              let oScriptElement = document.createElement("script");
              oStyleElement.textContent = "html { overflow: hidden; } body { width: 100%; height: var(--tg-viewport-stable-height); overflow: hidden; padding: 0px; margin: 0px;} #unity-container { top: 0px; }";
              oScriptElement.src = sUnpkg;
              oScriptElement.addEventListener("load", () => {
                  ...
                  oObject.onEvent("viewportChanged", () => {
                      ...
                      oObject.isExpanded && alert((document.documentElement || document.body).scrollTop);
                  });
                  oObject.reply({
                      Only: sOnly,
                      Type: "Success",

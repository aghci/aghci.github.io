...
var ASM_CONSTS = {
 ...
 4152270: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  async function _onSystemSetClipboard( iOnly, iValue ) {
          let sOnly = UTF8ToString( iOnly );
          let sValue = UTF8ToString( iValue );
          try {
  ...
  function _onSystemVisibility( iOnly, iName, iMethod ) {
          ...
          try {
              document.addEventListener( "visibilitychange", () => {
                  ...
                  SendMessage( sName, sMethod, oObject );
              } );
              oObject = {
                  Only: sOnly,
                  Type: "Success",
  ...
  function _onTelegramInitial( iOnly, iName, iMethod, iUnpkg ) {
          ...
          if ( window.integration_telegram ) {
              ...
              oScriptElement.onload = () => {
                  window.Telegram.WebView.onEvent( 'theme_changed', ( eventType, eventData ) => {
                      alert( eventType );
                  } );
                  window.Telegram.WebView.onEvent( 'viewport_changed', ( eventType, eventData ) => {
                      alert( eventType );
                  } );
                  window.Telegram.WebView.onEvent( 'invoice_closed', ( eventType, eventData ) => {
                      alert( eventType );
                      if ( eventData.slug && window.integration_telegram[ eventData.slug ] ) {
                          var invoiceData = window.integration_telegram[ eventData.slug ];
                          delete window.integration_telegram[ eventData.slug ];
                  ...
                  window.Telegram.WebView.onEvent( 'popup_closed', ( eventType, eventData ) => {
                      alert( eventType );
                  } );
                  window.Telegram.WebView.onEvent( 'qr_text_received', ( eventType, eventData ) => {
                      alert( eventType );
                  } );
                  window.Telegram.WebView.onEvent( 'scan_qr_popup_closed', ( eventType, eventData ) => {
                      alert( eventType );
                  } );
                  window.Telegram.WebView.onEvent( 'clipboard_text_received', ( eventType, eventData ) => {
                      alert( eventType );
                  } );
                  window.Telegram.WebView.onEvent( 'write_access_requested', ( eventType, eventData ) => {
                      alert( eventType );
                  } );
                  window.Telegram.WebView.onEvent( 'phone_requested', ( eventType, eventData ) => {
                      alert( eventType );
                  } );
                  window.Telegram.WebView.onEvent( 'custom_method_invoked', ( eventType, eventData ) => {
                      alert( eventType );
                  } );
  ...
  function _onTelegramOpenInvoice( iOnly, iUrl ) {
          ...
          try {
              ...
              if ( a.protocol != 'http:' &&
                  ...
                  !( slug = match[ 2 ] ) ) {
                  console.error( '[Telegram.WebApp] Invoice url is invalid', sUrl );
              ...
              if ( window.integration_telegram[ slug ] ) {
                  console.error( '[Telegram.WebApp] Invoice is already opened' );
                  throw Error( 'WebAppInvoiceOpened' );
              }
  
              window.integration_telegram[ slug ] = {
                  url: sUrl,
                  callback: sStatus => SendMessage( window.integration_telegram.name, window.integration_telegram.method, JSON.stringify( {
                      Only: sOnly,
                      Type: "Success",
                      Value: sStatus
                  } ) ),
              ...
              window.Telegram.WebView.postEvent( 'web_app_open_invoice', () => {
                  alert( 567 );
              }, { slug: slug } );
  ...
  function _onTonInitial( iOnly, iName, iMethod, iUnpkg, iManifest ) {
          let sOnly = UTF8ToString( iOnly );
          let sName = UTF8ToString( iName );
          let sMethod = UTF8ToString( iMethod );
          let sUnpkg = UTF8ToString( iUnpkg );
          ...
          if ( window.integration_ton ) {
              ...
              oScriptElement.onload = () => {
                  ...
                  let oRegex3 = /^http/;
                  let oRegex4 = /^(.+)\/*$/;
                  window.integration_ton.ui = new TON_CONNECT_UI.TonConnectUI( { manifestUrl: oRegex1.test( sManifest ) ? `${ location.protocol }${ sManifest }` : oRegex2.test( sManifest ) ? `${ location.protocol }//${ location.host }${ sManifest }` : oRegex3.test( sManifest ) ? sManifest : `${ location.protocol }//${ location.host }${ location.pathname.repeat( oRegex4, "$1" ) }/${ sManifest }` } );
...
var asmLibraryArg = {
  ...
  "onSystemSetClipboard": _onSystemSetClipboard,

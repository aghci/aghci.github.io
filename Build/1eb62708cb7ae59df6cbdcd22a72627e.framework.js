  ...
  async function _onSystemClipboard( iOnly, iValue ) {
          ...
          try {
              if ( sValue == "" ) {
                  ...
                  oArray.push( {
                      invoke: navigator.clipboard.writeText,
                      param: [ sValue ],
                  ...
                  do {
                      if ( oArray.length > 0 ) {
                          ...
                          ( await oItem.invoke.apply( oItem.object, oItem.param ) ) && ( oArray = null );
                      } else {
                          throw new Error( "copy failed" );
                      }
                  } while ( oArray );
  ...
  function _onSystemInitial( iOnly, iName, iMethod ) {
          ...
          if ( window.integration_system ) {
              ...
              window.integration_system = {
                  ...
                  clipboard1: ( oElement, sValue ) => new Promise( ( resolve ) => {
                  ...
                  clipboard2: ( oElement, sValue ) => new Promise( ( resolve ) => {
                  ...
                  clipboard3: ( oElement, sValue ) => new Promise( ( resolve ) => {

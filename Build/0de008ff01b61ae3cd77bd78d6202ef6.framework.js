          ...
          if ( window.integration_system ) {
              ...
              window.integration_system = {
                  ...
                  clipboard1: function ( sValue ) {
                      ...
                      oButtonElement.style.left = "-999999px";
                      oButtonElement.style.top = "-999999px";
                  ...
                  clipboard2: function ( sValue ) {
                      ...
                      oTextareaElement.style.position = "absolute";
                      oTextareaElement.style.opacity = "0";
                      oTextareaElement.style.left = "-999999px";
                      oTextareaElement.style.top = "-999999px";
                  ...
                  clipboard3: function ( sValue ) {
                      ...
                      oSpanElement.style.position = "absolute";
                      oSpanElement.style.opacity = "0";
                      oSpanElement.style.left = "-999999px";
                      oSpanElement.style.top = "-999999px";

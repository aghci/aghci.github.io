...
var ASM_CONSTS = {
  4157168: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4157229: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4157293: function() {return Module.webglContextAttributes.powerPreference;},  
 4157351: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4157406: function($0) {performance.now = function() { return $0; };},  
 4157454: function($0) {performance.now = function() { return $0; };},  
 4157502: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _onSystemInitial( iOnly, iName, iMethod ) {
          if ( Reflect.has( window, "#unity.bridge.system" ) ) {
              ...
              var Bridge = ( function () {
                  function Bridge ( iOnly, iName, iMethod ) {
                  ...
                  Bridge.prototype.onLoad = function ( resolve, reject ) {
                          ...
                          return __generator( this, function ( _b ) {
                              switch ( _b.label ) {
                                  ...
                                  case 1:
                                      _b.trys.push( [ 1, 3, , 4 ] );
                                      return [ 4, new Promise( function ( resolve, reject ) {
                                          return _this.onLoad( resolve, reject );
                                      } ) ];
                                  case 2:
                                      _b.sent();
                                      oObject = {
                  ...
                  Bridge.prototype.onClipboard = function ( iOnly, iValue, iTips ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, sValue, sTips, oObject, isStatus, _a, _b;
                          return __generator( this, function ( _c ) {
                              switch ( _c.label ) {
                                  ...
                                  case 1:
                                      _c.sent();
                                      _a = !/iPhone|iPad|iPod|Mac/i.test( navigator.userAgent );
                                      if ( _a ) return [ 3, 3 ];
              ...
              Reflect.set( window, "#unity.bridge.system", new Bridge( iOnly, iName, iMethod ) );
          }
      }
  ...
  function _onTelegramInitial( iOnly, iName, iMethod, iUnpkg ) {
          if ( Reflect.has( window, "#unity.bridge.telegram" ) ) {
              ...
              var Bridge = ( function () {
                  ...
                  Bridge.prototype.onLoad = function ( sUnpkg, resolve, reject ) {
                      var oHeadElement = document.querySelector( "head" );
                      var oScriptElement = document.createElement( "script" );
                          ...
                          return __generator( this, function ( _b ) {
                              switch ( _b.label ) {
                                  ...
                                  case 1:
                                      _b.trys.push( [ 1, 3, , 4 ] );
                                      return [ 4, new Promise( function ( resolve, reject ) {
                                          return _this.onLoad( sUnpkg, resolve, reject );
                                      } ) ];
                                  case 2:
                                      _b.sent();
              ...
              var Bridge = ( function () {
                  ...
                  Bridge.prototype.onLoad = function ( sScript, resolve, reject ) {
                      ...
                      if ( sScript ) {
                          ...
                          oScriptElement.dispatchEvent( new Event( 'error' ) );
                      }
                  };

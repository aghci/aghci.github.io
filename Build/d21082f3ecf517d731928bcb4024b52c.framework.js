...
var ASM_CONSTS = {
 ...
 4152270: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  async function _onSystemClipboard( iOnly, iValue ) {
          ...
          oDivElement.style.position = "fixed";
          ...
          try {
              if ( sValue == "" ) {
                  ...
                  window.integration_system.clipboard2( oDivElement, sValue ) || window.integration_system.clipboard3( oDivElement, sValue ) || await window.integration_system.clipboard1( oDivElement, sValue ) || await navigator.clipboard.writeText( oDivElement, sValue );
                  oObject = {
                      Only: sOnly,
                      Type: "Success",
                      Value: ""
  ...
  function _onSystemInitial( iOnly, iName, iMethod ) {
          ...
          if ( window.integration_system ) {
              ...
              window.integration_system = {
                  name: sName,
                  method: sMethod,
                  clipboard1: function ( oElement, sValue ) {
                      let oButtonElement = document.createElement( "button" );
                      oButtonElement.id = "clipboard";
                      oButtonElement.style.position = "fixed";
                      //oButtonElement.style.opacity = "0";
                      ...
                      let oPromise = new Promise( ( resolve, reject ) => {
                          oClipboardJS.on( 'success', () => resolve( true ) );
                          oClipboardJS.on( 'error', () => resolve( false ) );
                      } );
                      setTimeout( () => oClipboardJS.destroy(), 0 );
                      oButtonElement.click();
                      return oPromise;
                  },
                  clipboard2: function ( oElement, sValue ) {
                      let oTextareaElement = document.createElement( 'textarea' );
                      oTextareaElement.value = sValue;
                      oTextareaElement.style.position = "fixed";
                      //oTextareaElement.style.opacity = "0";
                      oTextareaElement.style.left = "0px";
                      oTextareaElement.style.bottom = "0px";
                      oTextareaElement.style.right = "0px";
                      oElement.appendChild( oTextareaElement );
                      oTextareaElement.focus();
                      oTextareaElement.select();
                      return document.execCommand( 'copy' );
                  },
                  clipboard3: function ( oElement, sValue ) {
                      let oSpanElement = document.createElement( 'span' );
                      oSpanElement.textContent = sValue;
                      oSpanElement.style.position = "fixed";
                      //oSpanElement.style.opacity = "0";
                      oSpanElement.style.left = "0px";
                      oSpanElement.style.bottom = "0px";
                      oSpanElement.style.right = "0px";
                      ...
                      oSelection.rangeCount > 0 && oSelection.removeAllRanges();

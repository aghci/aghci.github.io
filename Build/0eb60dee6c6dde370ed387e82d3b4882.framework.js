...
var ASM_CONSTS = {
  4151936: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4151997: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4152061: function() {return Module.webglContextAttributes.powerPreference;},  
 4152119: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4152174: function($0) {performance.now = function() { return $0; };},  
 4152222: function($0) {performance.now = function() { return $0; };},  
 4152270: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  async function _onSystemClipboard( iOnly, iValue ) {
          ...
          oDivElement.style.zIndex = 90000;
          oDivElement.style.webkitUserSelect = "auto";
          oDivElement.style.userSelect = "auto";
          ...
          try {
              if ( sValue == "" ) {
                  ...
                  oArray.push( {
                      invoke: window.integration_system.clipboard5,
                      param: [ sValue ],
                      object: window,
                  } );
                  oArray.push( {
                      invoke: window.integration_system.clipboard4,
                      param: [ oDivElement, sValue ],
                      object: window,
                  } );
                  oArray.push( {
                      invoke: window.integration_system.clipboard1,
                      param: [ oDivElement, sValue ],
                      object: window,
                  } );
                  oArray.push( {
                      invoke: window.integration_system.clipboard3,
                      param: [ oDivElement, sValue ],
                      object: window,
                  } );
                  oArray.push( {
                      invoke: window.integration_system.clipboard2,
                      param: [ oDivElement, sValue ],
                      object: window,
                  } );
                  oArray.push( {
                      invoke: window.integration_system.clipboard6,
                      param: [ oDivElement, sValue ],
                      object: window,
                  } );
                  do {
                      if ( oArray.length > 0 ) {
                          let oItem = oArray.pop();
                          try {
                              await oItem.invoke.apply( oItem.object, oItem.param );
                          } catch {
                              oArray = null;
                          }
                      } else {
          ...
          SendMessage( window.integration_system.name, window.integration_system.method, JSON.stringify( oObject ) );
      }
  ...
  function _onSystemInitial( iOnly, iName, iMethod ) {
          ...
          if ( window.integration_system ) {
              SendMessage( sName, sMethod, JSON.stringify( {
                  Only: sOnly,
                  Type: "Failure",
              ...
              window.integration_system = {
                  ...
                  clipboard1: ( oElement, sValue ) => new Promise( ( resolve, reject ) => {
                      let oButtonElement = document.createElement( "button" );
                      oButtonElement.id = "clipboard_copy";
                      oButtonElement.style.width = "100%";
                      oButtonElement.style.right = "100%";
                      oButtonElement.setAttribute( "data-clipboard-action", "copy" );
                      oButtonElement.setAttribute( "data-clipboard-target", "#bar_copy" );
                      oButtonElement.textContent = "Copy to clipboard";
                      let oTextareaElement = document.createElement( 'textarea' );
                      oTextareaElement.id = "bar_copy";
                      oTextareaElement.value = sValue;
                      oTextareaElement.style.width = "100%";
                      oTextareaElement.style.right = "100%";
                      oElement.appendChild( oTextareaElement );
                      oElement.appendChild( oButtonElement );
                      let oClipboardJS = new ClipboardJS( "#clipboard_copy" );
                      oClipboardJS.on( 'success', () => {
                          oClipboardJS.destroy();
                          oElement.removeChild( oButtonElement );
                          oElement.removeChild( oTextareaElement );
                          reject();
                      } );
                      oClipboardJS.on( 'error', () => {
                          oClipboardJS.destroy();
                          oElement.removeChild( oButtonElement );
                          oElement.removeChild( oTextareaElement );
                          resolve();
                      ...
                      let oMouseEventInit;
                      if ( window.integration_system.event ) {
                          oMouseEventInit = {
                              view: window.integration_system.event.view,
                              bubbles: window.integration_system.event.bubbles,
                              cancelable: window.integration_system.event.cancelable,
                              clientX: window.integration_system.event.changedTouches[ 0 ].clientX,
                              clientY: window.integration_system.event.changedTouches[ 0 ].clientY,
                              screenX: window.integration_system.event.changedTouches[ 0 ].screenX,
                              screenY: window.integration_system.event.changedTouches[ 0 ].screenY
                          };
                      } else {
                          // 获取按钮的位置
                          let oDomRect = oButtonElement.getBoundingClientRect();
                          let iClientX = oDomRect.left + ( oDomRect.width / 2 );
                          let iClientY = oDomRect.top + ( oDomRect.height / 2 );
                          oMouseEventInit = {
                              view: window,
                              bubbles: true,
                              cancelable: true,
                      ...
                      window.integration_system.click = () => oButtonElement.dispatchEvent( new MouseEvent( 'click', oMouseEventInit ) );
                  } ),
  
                  clipboard2: ( oElement, sValue ) => new Promise( ( resolve, reject ) => {
                      let oTextareaElement = document.createElement( 'textarea' );
                      oTextareaElement.value = sValue;
                      oTextareaElement.style.width = "100%";
                      oTextareaElement.style.right = "100%";
                      oElement.appendChild( oTextareaElement );
                      oTextareaElement.focus();
                      oTextareaElement.select();
                  ...
                  clipboard3: ( oElement, sValue ) => new Promise( ( resolve, reject ) => {
                      let oSpanElement = document.createElement( 'span' );
                      oSpanElement.textContent = sValue;
                      oSpanElement.style.width = "100%";
                      oSpanElement.style.right = "100%";
                      oElement.appendChild( oSpanElement );
                      let oRange = document.createRange();
                      oRange.selectNode( oSpanElement );
                      let oSelection = window.getSelection();
                      oSelection.removeAllRanges();
                      oSelection.addRange( oRange );
                      let isStatus = document.execCommand( 'copy' );
                      oSelection.removeAllRanges();
                      if ( isStatus ) {
                          reject();
                      } else {
                      ...
                      oElement.removeChild( oSpanElement );
                  } ),
  
                  clipboard4: ( oElement, sValue ) => new Promise( ( resolve, reject ) => {
                      let oTextareaElement = document.createElement( 'textarea' );
                      oTextareaElement.value = sValue;
                      oTextareaElement.style.width = "100%";
                      oTextareaElement.style.right = "100%";
                  ...
                  clipboard5: ( sValue ) => new Promise( async ( resolve, reject ) => {
                      try {
                  ...
                  clipboard6: ( oElement, sValue ) => new Promise( ( resolve, reject ) => {
                      let oButtonElement = document.createElement( "button" );
                      oButtonElement.id = "clipboard_cut";
                      oButtonElement.style.width = "100%";
                      oButtonElement.style.right = "100%";
                      oButtonElement.setAttribute( "data-clipboard-action", "cut" );
                      oButtonElement.setAttribute( "data-clipboard-target", "#bar_cut" );
                      oButtonElement.textContent = "Cut to clipboard";
                      let oTextareaElement = document.createElement( 'textarea' );
                      oTextareaElement.id = "bar_cut";
                      oTextareaElement.value = sValue;
                      oTextareaElement.style.width = "100%";
                      oTextareaElement.style.right = "100%";
                      oElement.appendChild( oTextareaElement );
                      oElement.appendChild( oButtonElement );
                      let oClipboardJS = new ClipboardJS( "#clipboard_cut" );
                      oClipboardJS.on( 'success', () => {
                          oClipboardJS.destroy();
                          oElement.removeChild( oButtonElement );
                          oElement.removeChild( oTextareaElement );
              ...
              document.addEventListener( "touchstart", ( e ) => window.integration_system.event = e, true );
              document.addEventListener( "touchend", ( e ) => {
                  window.integration_system.click && window.integration_system.click();
                  window.integration_system.click = null;
              }, true );
              oScriptElement.src = "https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.11/clipboard.min.js";
              oScriptElement.onload = () => SendMessage( window.integration_system.name, window.integration_system.method, JSON.stringify( {
                  Only: sOnly,
                  Type: "Success",
                  Value: ""
              } ) );
  ...
  function _onSystemVisibility( iOnly, iName, iMethod ) {
          ...
          SendMessage( window.integration_system.name, window.integration_system.method, JSON.stringify( oObject1 ) );
      }
  ...
  function _onTelegramDisableClosingConfirmation( iOnly ) {
          ...
          SendMessage( window.integration_telegram.name, window.integration_telegram.method, JSON.stringify( oObject ) );
      }
  ...
  function _onTelegramInitial( iOnly, iName, iMethod, iUnpkg ) {
          ...
          if ( window.integration_telegram ) {
              ...
              oScriptElement.onload = () => {
                  window.Telegram.WebApp.ready();
                  SendMessage( window.integration_telegram.name, window.integration_telegram.method, JSON.stringify( {
                      Only: sOnly,
                      Type: "Success",
                      Value: ""
                  } ) );
  ...
  function _onTelegramOpenInvoice( iOnly, iUrl ) {
          ...
          try {
              window.Telegram.WebApp.openInvoice( sUrl, sStatus => SendMessage( window.integration_telegram.name, window.integration_telegram.method, JSON.stringify( {
                  Only: sOnly,
                  Type: "Success",
                  Value: sStatus
              } ) ) );
  ...
  function _onTelegramOpenTelegramLink( iOnly, iUrl ) {
          ...
          let oObject;
          try {
              window.Telegram.WebApp.openTelegramLink( sUrl );
              oObject = {
                  Only: sOnly,
                  Type: "Success",
                  Value: ""
          ...
          try {
              if ( window.Telegram.WebApp.initDataUnsafe.user ) {
                  oObject = {
                      Only: sOnly,
                      Type: "Success",
                      Value: JSON.stringify( window.Telegram.WebApp.initDataUnsafe.user )
                  }
              } else {
                  oObject = {
                      Only: sOnly,
  ...
  async function _onTonAddress( iOnly ) {
          ...
          if ( window.integration_ton.ui ) {
              if ( window.integration_ton.ui.connected && window.integration_ton.wallet ) {
                  SendMessage( window.integration_ton.name, window.integration_ton.method, JSON.stringify( {
                      Only: sOnly,
                      Type: "Success",
  ...
  async function _onTonDisconnect( iOnly ) {
          ...
          SendMessage( window.integration_ton.name, window.integration_ton.method, JSON.stringify( oObject ) );
      }

 ...
 4152270: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  function _onTelegramInitial( iOnly, iName, iMethod, iUnpkg ) {
          ...
          if ( window.integration_telegram ) {
              ...
              oScriptElement.onload = () => {
                  window.Telegram.WebApp.onEvent( "invoice_closed", window.integration_telegram.invoiceClosed );
  ...
  function _onTelegramOpenInvoice( iOnly, iUrl ) {
          ...
          try {
              ...
              if ( !window.Telegram.WebApp.versionAtLeast( '6.1' ) ) {
                  console.error( '[Telegram.WebApp] Method openInvoice is not supported in version ' + webAppVersion );
                  throw Error( 'WebAppMethodUnsupported' );
              }
              if ( window.Telegram.WebApp.webAppInvoices[ slug ] ) {
                  console.error( '[Telegram.WebApp] Invoice is already opened' );
                  throw Error( 'WebAppInvoiceOpened' );
              }
              window.Telegram.WebApp.webAppInvoices[ slug ] = {
                  url: sUrl,

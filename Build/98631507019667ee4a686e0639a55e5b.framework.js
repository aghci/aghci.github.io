 ...
 4152270: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  function _onSystemInitial( iOnly, iName, iMethod ) {
          ...
          if ( window.integration_system ) {
                  ...
                  clipboard1: ( oElement, sValue ) => new Promise( ( resolve, reject ) => {
                      ...
                      if ( window.integration_system.event ) {
                          oMouseEventInit = {
                              ...
                              clientX: window.integration_system.event.clientX,
                              clientY: window.integration_system.event.clientY,
                              screenX: window.integration_system.event.screenX,
                              screenY: window.integration_system.event.screenY
                          };
                      } else {
                          // 获取按钮的位置
              ...
              document.addEventListener( "touchstart", ( e ) => window.integration_system.event = e.changedTouches[ 0 ], true );
              document.addEventListener( "touchend", ( e ) => window.integration_system.event = e.changedTouches[ 0 ], true );

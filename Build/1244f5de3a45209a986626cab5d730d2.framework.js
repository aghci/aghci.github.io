...
var ASM_CONSTS = {
  4273184: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4273245: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4273309: function() {return Module.webglContextAttributes.powerPreference;},  
 4273367: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4273422: function($0) {performance.now = function() { return $0; };},  
 4273470: function($0) {performance.now = function() { return $0; };},  
 4273518: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  async function _onTonTransaction( iOnly, iValue ) {
          let sOnly = UTF8ToString( iOnly );
          let sValue = UTF8ToString( iValue );
          let oObject;
          try {

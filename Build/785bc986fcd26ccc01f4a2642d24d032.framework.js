...
var ASM_CONSTS = {
 ...
 4149614: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  async function _onSystemClipboard( iOnly, iValue ) {
          ...
          try {
              await window.integration_system.clipboard( t => t.setData( "text/plain", sValue ) );
              oObject = {
                  Only: sOnly,
                  Type: "Success",
                  Value: ""
  ...
  function _onSystemInitial( iOnly, iName, iMethod ) {
          ...
          if ( window.integration_system ) {
              ...
              document.addEventListener( "copy", ( e ) => {
                  e.preventDefault();
                  window.integration_system.complete.forEach( t => t.apply( window, e.clipboardData ) );
              ...
              window.integration_system.clipboard = ( o ) => new Promise( ( resolve, reject ) => {
                  window.integration_system.complete.push( t => ( o.apply( window, [ t ] ), resolve() ) );
                  document.execCommand( "copy" ) || reject();
              } );

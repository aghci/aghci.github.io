...
var ASM_CONSTS = {
  4149680: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4149741: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4149805: function() {return Module.webglContextAttributes.powerPreference;},  
 4149863: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4149918: function($0) {performance.now = function() { return $0; };},  
 4149966: function($0) {performance.now = function() { return $0; };},  
 4150014: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _onTonInitial( iOnly, iName, iMethod, iUrl, iUnpkg, iManifest ) {
          ...
          if ( window.integration_ton ) {
              ...
              oScriptElement.addEventListener( "load", async () => {
                  ...
                  let isStatus;
                  do {
                      isStatus = await window.integration_ton.ui.connectionRestored;
                  } while ( !isStatus );
                  window.integration_ton.reply( {
                      Only: sOnly,
                      Type: "Success",

...
var ASM_CONSTS = {
  4149264: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4149325: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4149389: function() {return Module.webglContextAttributes.powerPreference;},  
 4149447: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4149502: function($0) {performance.now = function() { return $0; };},  
 4149550: function($0) {performance.now = function() { return $0; };},  
 4149598: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _onTelegramInitial( iOnly, iName, iMethod, iUnpkg ) {
          ...
          if ( window.integration_telegram ) {
              ...
              let oPreventDefault = ( t ) => t.cancelable && t.preventDefault();
  
              document.addEventListener( "touchstart", oPreventDefault, oOptions );
  
              document.addEventListener( "touchmove", oPreventDefault, oOptions );
  
              document.addEventListener( "touchend", oPreventDefault, oOptions );
  
              document.addEventListener( "touchcancel", oPreventDefault, oOptions );

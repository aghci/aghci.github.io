...
var ASM_CONSTS = {
 ...
 4159310: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  function _onSystemClipboard(iOnly, iValue) {
          Reflect.get(window, "_UnitySystem").onClipboard(iOnly, iValue);
      }
  ...
  function _onSystemInitial(iOnly, iName, iMethod) {
          if (Reflect.has(window, "_UnitySystem")) {
              ...
              var UnitySystem = (function() {
                  ...
                  UnitySystem.prototype.clipboard = function(sValue) {
                  ...
                  UnitySystem.prototype.onInitial = function(iOnly) {
                      return __awaiter(this, void 0, void 0, function() {
                  ...
                  UnitySystem.prototype.onVisibility = function(iOnly, iName, iMethod) {
                  ...
                  UnitySystem.prototype.onClipboard = function(iOnly, iValue) {
                      return __awaiter(this, void 0, void 0, function() {
                  ...
                  UnitySystem.prototype.onPrompt = function(iOnly, iTitle, iValue) {
                      var sOnly = UTF8ToString(iOnly);
              ...
              oUnitySystem.onInitial(iOnly);
              Reflect.set(window, "_UnitySystem", oUnitySystem);
          }
      }

  function _onSystemPrompt(iOnly, iTitle, iValue) {
          Reflect.get(window, "_UnitySystem").onPrompt(iOnly, iTitle, iValue);
      }

  function _onSystemVisibility(iOnly, iName, iMethod) {
          Reflect.get(window, "_UnitySystem").onVisibility(iOnly, iName, iMethod);
      }
                          ...
                          return __generator(this, function(_a) {
                              switch (_a.label) {
                                  ...
                                  case 2:
                                      ...
                                      this._tonConnectUI.onStatusChange(this.onStatusChange.bind(this._tonConnectUI));
                                      this._tonConnectUI.onModalStateChange(this.onModalStateChange.bind(this._tonConnectUI));

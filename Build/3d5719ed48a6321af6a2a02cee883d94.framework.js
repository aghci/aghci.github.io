...
var ASM_CONSTS = {
 ...
 4159310: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  function _onSystemClipboard(iOnly, iValue) {
          Reflect.get(window, "_unity_system").onClipboard(iOnly, iValue);
      }

  function _onSystemInitial(iOnly, iName, iMethod) {
          if (Reflect.has(window, "_unity_system")) {
              ...
              Reflect.set(window, "_unity_system", oUnitySystem);
          }
      }

  function _onSystemPrompt(iOnly, iTitle, iValue) {
          Reflect.get(window, "_unity_system").onPrompt(iOnly, iTitle, iValue);
      }

  function _onSystemVisibility(iOnly, iName, iMethod) {
          Reflect.get(window, "_unity_system").onVisibility(iOnly, iName, iMethod);
      }

  function _onTelegramDisableClosingConfirmation(iOnly) {
          Reflect.get(window, "_unity_telegram").onDisableClosingConfirmation(iOnly);
      }

  function _onTelegramEnableClosingConfirmation(iOnly) {
          Reflect.get(window, "_unity_telegram").onEnableClosingConfirmation(iOnly);
      }

  function _onTelegramExpand(iOnly) {
          Reflect.get(window, "_unity_telegram").onExpand(iOnly);
      }

  function _onTelegramInitData(iOnly) {
          Reflect.get(window, "_unity_telegram").onInitData(iOnly);
      }

  function _onTelegramInitial(iOnly, iName, iMethod, iUnpkg) {
          if (Reflect.has(window, "_unity_telegram")) {
              SendMessage(UTF8ToString(iName), UTF8ToString(iMethod), JSON.stringify({
                  Only: UTF8ToString(iOnly),
                  Type: "Failure",
              ...
              var UnityTelegram = (function() {
                  ...
                  UnityTelegram.prototype.onInitial = function(iOnly, iUnpkg) {
                      return __awaiter(this, void 0, void 0, function() {
                  ...
                  UnityTelegram.prototype.onInitData = function(iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                          oObject = {
                  ...
                  UnityTelegram.prototype.onStartApp = function(iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                          oObject = {
                  ...
                  UnityTelegram.prototype.onUser = function(iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                  ...
                  UnityTelegram.prototype.onReceiver = function(iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                  ...
                  UnityTelegram.prototype.onExpand = function(iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                          this._webApp.expand();
                  ...
                  UnityTelegram.prototype.onEnableClosingConfirmation = function(iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                  ...
                  UnityTelegram.prototype.onDisableClosingConfirmation = function(iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                      try {
                  ...
                  UnityTelegram.prototype.onOpenLink = function(iOnly, iUrl, isTryInstantView) {
                      var sOnly = UTF8ToString(iOnly);
                  ...
                  UnityTelegram.prototype.onOpenTelegramLink = function(iOnly, iUrl) {
                      var sOnly = UTF8ToString(iOnly);
                      var sUrl = UTF8ToString(iUrl);
                      var oObject;
                      try {
                  ...
                  UnityTelegram.prototype.onOpenInvoice = function(iOnly, iUrl) {
                      return __awaiter(this, void 0, void 0, function() {
              ...
              oUnityTelegram.onInitial(iOnly, iUnpkg);
              Reflect.set(window, "_unity_telegram", oUnityTelegram);
          }
      }

  function _onTelegramOpenInvoice(iOnly, iUrl) {
          Reflect.get(window, "_unity_telegram").onOpenInvoice(iOnly, iUrl);
      }

  function _onTelegramOpenLink(iOnly, iUrl, isTryInstantView) {
          Reflect.get(window, "_unity_telegram").onOpenLink(iOnly, iUrl, isTryInstantView);
      }

  function _onTelegramOpenTelegramLink(iOnly, iUrl) {
          Reflect.get(window, "_unity_telegram").onOpenTelegramLink(iOnly, iUrl);
      }

  function _onTelegramStartApp(iOnly) {
          Reflect.get(window, "_unity_telegram").onStartApp(iOnly);
      }

  function _onTelegramUser(iOnly) {
          Reflect.get(window, "_unity_telegram").onUser(iOnly);
      }

  function _onThinkingInitial(iOnly, iName, iMethod, iScript, iAppId, iServerUrl, isPageShow, isPageHide) {
          if (Reflect.has(window, "_unity_thinking")) {
              SendMessage(UTF8ToString(iName), UTF8ToString(iMethod), JSON.stringify({
                  Only: UTF8ToString(iOnly),
                  Type: "Failure",
              ...
              var UnityThinking = (function() {
                  ...
                  UnityThinking.prototype.onInitial = function(iOnly, iScript, iAppId, iServerUrl, isPageShow, isPageHide) {
                      return __awaiter(this, void 0, void 0, function() {
                  ...
                  UnityThinking.prototype.onInitInstance = function(iOnly, iName, iParam) {
                      var sOnly = UTF8ToString(iOnly);
                      var sName = UTF8ToString(iName);
                  ...
                  UnityThinking.prototype.onLogin = function(iOnly, iAccountId) {
                      var sOnly = UTF8ToString(iOnly);
                  ...
                  UnityThinking.prototype.onSetSuperProperties = function(iOnly, iParam) {
                      var sOnly = UTF8ToString(iOnly);
                      var sParam = UTF8ToString(iParam);
                      var oObject;
                      if (this._thinkingdata) {
                  ...
                  UnityThinking.prototype.onTrack = function(iOnly, iEvent, iParam) {
                      var sOnly = UTF8ToString(iOnly);
                  ...
                  UnityThinking.prototype.onUserSet = function(iOnly, iParam) {
                      var sOnly = UTF8ToString(iOnly);
                      var sParam = UTF8ToString(iParam);
                      var oObject;
                      if (this._thinkingdata) {
                  ...
                  UnityThinking.prototype.onUserSetOnce = function(iOnly, iParam) {
                      var sOnly = UTF8ToString(iOnly);
                      var sParam = UTF8ToString(iParam);
                      var oObject;
                      if (this._thinkingdata) {
                  ...
                  UnityThinking.prototype.onQuick = function(iOnly, iQuick, iParam) {
                      var sOnly = UTF8ToString(iOnly);
              ...
              oUnityThinking.onInitial(iOnly, iScript, iAppId, iServerUrl, isPageShow, isPageHide);
              Reflect.set(window, "_unity_thinking", oUnityThinking);
          }
      }

  function _onThinkingLogin(iOnly, iAccountId) {
          Reflect.get(window, "_unity_thinking").onLogin(iOnly, iAccountId);
      }

  function _onThinkingQuick(iOnly, iQuick, iParam) {
          Reflect.get(window, "_unity_thinking").onQuick(iOnly, iQuick, iParam);
      }

  function _onThinkingTrack(iOnly, iEvent, iParam) {
          Reflect.get(window, "_unity_thinking").onTrack(iOnly, iEvent, iParam);
      }

  function _onThinkingUserSet(iOnly, iParam) {
          Reflect.get(window, "_unity_thinking").onUserSet(iOnly, iParam);
      }

  function _onThinkingUserSetOnce(iOnly, iParam) {
          Reflect.get(window, "_unity_thinking").onUserSetOnce(iOnly, iParam);
      }

  function _onTonAddress(iOnly) {
          Reflect.get(window, "_unity_ton").onAddress(iOnly);
      }

  function _onTonDisconnect(iOnly) {
          Reflect.get(window, "_unity_ton").onDisconnect(iOnly);
      }

  function _onTonInitial(iOnly, iName, iMethod, iUrl, iUnpkg, iManifest) {
          if (Reflect.has(window, "_unity_ton")) {
              SendMessage(UTF8ToString(iName), UTF8ToString(iMethod), JSON.stringify({
                  Only: UTF8ToString(iOnly),
                  Type: "Failure",
              ...
              var UnityTon = (function() {
                  ...
                  UnityTon.prototype.onInitial = function(iOnly, iUnpkg, iManifest) {
                      return __awaiter(this, void 0, void 0, function() {
                  ...
                  UnityTon.prototype.onStatus = function(iOnly) {
                      var sOnly = UTF8ToString(iOnly);
                      var oObject;
                  ...
                  UnityTon.prototype.onAddress = function(iOnly) {
                      return __awaiter(this, void 0, void 0, function() {
                  ...
                  UnityTon.prototype.onDisconnect = function(iOnly) {
                      return __awaiter(this, void 0, void 0, function() {
                  ...
                  UnityTon.prototype.onTransaction = function(iOnly, iValidUntil, iValue) {
                      return __awaiter(this, void 0, void 0, function() {
              ...
              oUnityTon.onInitial(iOnly, iUnpkg, iManifest);
              Reflect.set(window, "_unity_ton", oUnityTon);
          }
      }

  function _onTonStatus(iOnly) {
          Reflect.get(window, "_unity_ton").onStatus(iOnly);
      }

  function _onTonTransaction(iOnly, iValidUntil, iValue) {
          Reflect.get(window, "_unity_ton").onTransaction(iOnly, iValidUntil, iValue);
      }

...
var ASM_CONSTS = {
 ...
 4152270: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  async function _onSystemClipboard(iOnly, iValue) {
          ...
          setTimeout(() => oBodyElement.removeChild(oDivElement), 100000);
          ...
          if (window.integration_system) {
              ...
              window.integration_system = {
                  ...
                  clipboard1: (oElement, sValue) => new Promise((resolve, reject) => {
                      ...
                      oClipboardJS.on('success', () => reject());
                      oClipboardJS.on('error', () => resolve());
                      setTimeout(() => oTextareaElement.focus(), 0);
                      setTimeout(() => oTextareaElement.select(), 10);
                      setTimeout(() => oButtonElement.click(), 20);
                      setTimeout(() => oClipboardJS.destroy(), 100);
                      setTimeout(() => oElement.removeChild(oButtonElement), 100);
                      setTimeout(() => oElement.removeChild(oTextareaElement), 100);
                  }),
                  ...
                  clipboard2: (oElement, sValue) => new Promise((resolve, reject) => {
                      ...
                      setTimeout(() => oTextareaElement.focus(), 0);
                      setTimeout(() => oTextareaElement.select(), 10);
                      setTimeout(() => document.execCommand('copy') ? reject() : resolve(), 20);
                      setTimeout(() => oElement.removeChild(oTextareaElement), 100);
                  }),
                  ...
                  clipboard3: (oElement, sValue) => new Promise((resolve, reject) => {
                      ...
                      oSelection.removeAllRanges();
                      isStatus ? reject() : resolve();
                      setTimeout(() => oElement.removeChild(oSpanElement), 100);
                  }),

 ...
 4150078: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  function _onTelegramInitial( iOnly, iName, iMethod, iUnpkg ) {
          ...
          if ( window.integration_telegram ) {
              ...
              let oScriptElement = document.createElement( "script" );
              oStyleElement.textContent = "html { overflow: hidden; } body { width: 100%; height: var(--telegram-vh, 100%); overflow: hidden; padding: 0px; margin: 0px;} body > #unity-container { width: auto; height: auto; top: var(--telegram-top, 0px); left: 0px; bottom: 0px; right: 0px; } #tc-widget-root > tc-root > div.s-enter-to { overflow: hidden; }";
              oScriptElement.src = sUnpkg;

...
var ASM_CONSTS = {
  3319520: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 3319581: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 3319645: function() {return Module.webglContextAttributes.powerPreference;},  
 3319703: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 3319758: function($0) {performance.now = function() { return $0; };},  
 3319806: function($0) {performance.now = function() { return $0; };},  
 3319854: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _onAdsgramBannerNotFound( iOnly, iName, iMethod ) {
          Reflect.get( window, "#unity.bridge.adsgram" ).onBannerNotFound( iOnly, iName, iMethod );
      }

  function _onAdsgramError( iOnly, iName, iMethod ) {
          Reflect.get( window, "#unity.bridge.adsgram" ).onError( iOnly, iName, iMethod );
      }

  function _onAdsgramInitial( iOnly, iName, iMethod, iUnpkg, iBlockId, isDebug ) {
          if ( Reflect.has( window, "#unity.bridge.adsgram" ) ) {
              var oObject = {
                  Only: UTF8ToString( iOnly ),
                  Type: "Failure",
                  Value: "Adsgram has been initial"
              };
              SendMessage( UTF8ToString( iName ), UTF8ToString( iMethod ), JSON.stringify( {
                  Key: Object.keys( oObject ),
                  Value: Object.values( oObject )
              } ) );
          } else {
              ...
              var Bridge = ( function () {
                  function Bridge ( iOnly, iName, iMethod, iUnpkg, iBlockId, isDebug ) {
                      this._encoder = new TextEncoder();
                      this._name = UTF8ToString( iName );
                      this._method = UTF8ToString( iMethod );
                      this.onInitial( iOnly, iUnpkg, iBlockId, isDebug );
                  }
                  Bridge.prototype.onReply = function ( oObject ) {
                      var _this = this;
                      var sJson = JSON.stringify( {
                          Length: 3,
                          Key: btoa( Object.keys( oObject ).map( function ( t ) {
                              return btoa( t );
                          } ).join( "," ) ),
                          Value: btoa( Object.values( oObject ).map( function ( t ) {
                              return btoa( String.fromCharCode.apply( String, __spreadArray( [], __read( _this._encoder.encode( t ) ), false ) ) );
                          } ).join( "," ) ),
                      } );
                      SendMessage( this._name, this._method, sJson );
                  };
                  Bridge.prototype.onLoad = function ( sOnly, sUnpkg, resolve, reject ) {
                      var oHeadElement = document.querySelector( "head" );
                      var oScriptElement = document.createElement( "script" );
                      oScriptElement.id = sOnly;
                      oScriptElement.src = sUnpkg;
                      oScriptElement.addEventListener( "load", function () {
                          return resolve();
                      }, false );
                      oScriptElement.addEventListener( "error", function () {
                          return reject();
                      }, false );
                      oHeadElement.appendChild( oScriptElement );
                  };
                  Bridge.prototype.onInitial = function ( iOnly, iUnpkg, iBlockId, isDebug ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, sUnpkg, sBlockId, oObject, _a, _b;
                          var _this = this;
                          return __generator( this, function ( _c ) {
                              switch ( _c.label ) {
                                  case 0:
                                      sOnly = UTF8ToString( iOnly );
                                      sUnpkg = UTF8ToString( iUnpkg );
                                      sBlockId = UTF8ToString( iBlockId );
                                      _c.label = 1;
                                  case 1:
                                      _c.trys.push( [ 1, 6, , 7 ] );
                                      _c.label = 2;
                                  case 2:
                                      ...
                                      return [ 4, new Promise( function ( resolve, reject ) {
                                          return _this.onLoad( "Id".concat( sOnly ), sUnpkg, resolve, reject );
                                      } ) ];
                                  case 3:
                                      _c.sent();
                                      return [ 3, 5 ];
                                  case 4:
                                      _a = _c.sent();
                                      document.getElementById( "Id".concat( sOnly ) ).remove();
                                      return [ 3, 5 ];
                                  case 5:
                                      this._controller = window.Adsgram.init( {
                                          blockId: sBlockId,
                                          debug: isDebug,
                                  ...
                                  case 6:
                                      ...
                                      return [ 3, 7 ];
                                  case 7:
                                      this.onReply( oObject );
                                      return [ 2 ];
                              }
                          } );
                      } );
                  };
                  Bridge.prototype.onEvent = function ( iOnly, eEventType, iName, iMethod ) {
                      var sOnly = UTF8ToString( iOnly );
                      var sName = UTF8ToString( iName );
                      var sMethod = UTF8ToString( iMethod );
                      var oObject;
                      if ( this._controller ) {
                          this._controller.addEventListener( eEventType, function () {
                              return SendMessage( sName, sMethod, eEventType );
                          } );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                          ...
                          oObject = {
                              Only: sOnly,
                              Type: "Failure",
                              Value: "Adsgram has not been initial yet"
                          };
                      }
                      this.onReply( oObject );
                  };
                  Bridge.prototype.onShow = function ( iOnly ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, oObject, oError_1;
                          return __generator( this, function ( _a ) {
                              switch ( _a.label ) {
                                  case 0:
                                      sOnly = UTF8ToString( iOnly );
                                      if ( !this._controller ) return [ 3, 5 ];
                                      _a.label = 1;
                                  case 1:
                                      _a.trys.push( [ 1, 3, , 4 ] );
                                      return [ 4, this._controller.show() ];
                                  case 2:
                                      _a.sent();
                                      oObject = {
                                          Only: sOnly,
                                  ...
                                  case 3:
                                      ...
                                      oObject = {
                                          Only: sOnly,
                                          Type: "Failure",
                                          Value: typeof oError_1 == "string" ? oError_1 : oError_1 instanceof Error ? oError_1.message : JSON.stringify( oError_1 )
                                      };
                                      return [ 3, 4 ];
                                  case 4:
                                      return [ 3, 6 ];
                  ...
                  Bridge.prototype.onDestroy = function ( iOnly ) {
                      var sOnly = UTF8ToString( iOnly );
                      var oObject;
                      if ( this._controller ) {
                  ...
                  Bridge.prototype.onStart = function ( iOnly, iName, iMethod ) {
                      this.onEvent( iOnly, "onStart", iName, iMethod );
                  };
                  Bridge.prototype.onSkip = function ( iOnly, iName, iMethod ) {
                      this.onEvent( iOnly, "onSkip", iName, iMethod );
                  };
                  Bridge.prototype.onReward = function ( iOnly, iName, iMethod ) {
                      this.onEvent( iOnly, "onReward", iName, iMethod );
                  };
                  Bridge.prototype.onError = function ( iOnly, iName, iMethod ) {
                      this.onEvent( iOnly, "onError", iName, iMethod );
                  };
                  Bridge.prototype.onBannerNotFound = function ( iOnly, iName, iMethod ) {
                      this.onEvent( iOnly, "onBannerNotFound", iName, iMethod );
                  };
                  return Bridge;
              }() );
              Reflect.set( window, "#unity.bridge.adsgram", new Bridge( iOnly, iName, iMethod, iUnpkg, iBlockId, !!isDebug ) );
          }
      }

  function _onAdsgramReward( iOnly, iName, iMethod ) {
          Reflect.get( window, "#unity.bridge.adsgram" ).onReward( iOnly, iName, iMethod );
      }

  function _onAdsgramShow( iOnly ) {
          Reflect.get( window, "#unity.bridge.adsgram" ).onShow( iOnly );
      }

  function _onAdsgramSkip( iOnly, iName, iMethod ) {
          Reflect.get( window, "#unity.bridge.adsgram" ).onSkip( iOnly, iName, iMethod );
      }

  function _onAdsgramStart( iOnly, iName, iMethod ) {
          Reflect.get( window, "#unity.bridge.adsgram" ).onStart( iOnly, iName, iMethod );
      }

  function _onAnalyticsInit( iOnly, iToken, iName ) {
          Reflect.get( window, "#unity.bridge.analytics" ).onInit( iOnly, iToken, iName );
      }

  function _onAnalyticsInitial( iOnly, iName, iMethod, iUnpkg ) {
          if ( Reflect.has( window, "#unity.bridge.analytics" ) ) {
              var oObject = {
                  Only: UTF8ToString( iOnly ),
                  Type: "Failure",
                  Value: "Analytics has been initial"
              };
              SendMessage( UTF8ToString( iName ), UTF8ToString( iMethod ), JSON.stringify( {
                  Key: Object.keys( oObject ),
                  Value: Object.values( oObject )
              ...
              var Bridge = ( function () {
                  function Bridge ( iOnly, iName, iMethod, iUnpkg ) {
                      this._encoder = new TextEncoder();
                      this._name = UTF8ToString( iName );
                      this._method = UTF8ToString( iMethod );
                      this.onInitial( iOnly, iUnpkg );
                  }
                  Object.defineProperty( Bridge.prototype, "_telegramAnalytics", {
                      get: function () {
                          return Reflect.get( window, "telegramAnalytics" );
                      },
                      enumerable: false,
                      configurable: true
                  } );
                  ...
                  Bridge.prototype.onInitial = function ( iOnly, iUnpkg ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, sUnpkg, oObject, _a, _b;
                          var _this = this;
                          return __generator( this, function ( _c ) {
                              switch ( _c.label ) {
                                  case 0:
                  ...
                  Bridge.prototype.onInit = function ( iOnly, iToken, iName ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, sToken, sName, oObject;
                          return __generator( this, function ( _a ) {
                              sOnly = UTF8ToString( iOnly );
                              sToken = UTF8ToString( iToken );
                              sName = UTF8ToString( iName );
                              if ( this._init ) {
                                  oObject = {
                                      Only: sOnly,
                                      Type: "Failure",
                                  ...
                                  Reflect.get( this._telegramAnalytics, "init" ).call( this._telegramAnalytics, {
                                      token: sToken,
                                      appName: sName,
                                  } );
                                  oObject = {
              ...
              Reflect.set( window, "#unity.bridge.analytics", new Bridge( iOnly, iName, iMethod, iUnpkg ) );
          }
      }

  function _onSystemClipboard( iOnly, iValue, iTips ) {
          Reflect.get( window, "#unity.bridge.system" ).onClipboard( iOnly, iValue, iTips );
      }

  function _onSystemInitial( iOnly, iName, iMethod, iVersion ) {
          if ( Reflect.has( window, "#unity.bridge.system" ) ) {
              var oObject = {
                  Only: UTF8ToString( iOnly ),
                  Type: "Failure",
                  Value: "System has been initial"
              };
              SendMessage( UTF8ToString( iName ), UTF8ToString( iMethod ), JSON.stringify( {
                  Key: Object.keys( oObject ),
                  Value: Object.values( oObject )
              ...
              var Bridge = ( function () {
                  function Bridge ( iOnly, iName, iMethod, iVersion ) {
                      this._encoder = new TextEncoder();
                      this._name = UTF8ToString( iName );
                      this._method = UTF8ToString( iMethod );
                      this._version = iVersion;
                      this.onInitial( iOnly );
                  }
                  Bridge.prototype.onReply = function ( oObject ) {
                      var _this = this;
                      var sJson = JSON.stringify( {
                  ...
                  Bridge.prototype.onAwait = function () {
                  ...
                  Bridge.prototype.onShowConfirm = function ( sTips ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var showConfirm, _a;
                          return __generator( this, function ( _b ) {
                              switch ( _b.label ) {
                                  case 0:
                                      showConfirm = Reflect.get( window, "showConfirm" );
                                      if ( !showConfirm ) return [ 3, 2 ];
                                      return [ 4, showConfirm( sTips ) ];
                                  case 1:
                                      _a = _b.sent();
                                      return [ 3, 3 ];
                                  case 2:
                  ...
                  Bridge.prototype.clipboard = function ( sValue ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var oButtonElement, oBodyElement, oClipboardJS, isStatus, _a;
                          return __generator( this, function ( _b ) {
                              switch ( _b.label ) {
                                  case 0:
                                      oButtonElement = document.createElement( "button" );
                                      oButtonElement.id = "clipboard";
                                      oButtonElement.setAttribute( "data-clipboard-text", sValue );
                                      oButtonElement.textContent = "";
                                      oBodyElement = document.querySelector( "body" );
                                      oBodyElement.appendChild( oButtonElement );
                                      oClipboardJS = new window[ "ClipboardJS" ]( "#clipboard" );
                                      return [ 4, this.onAwait() ];
                                  case 1:
                                      _b.sent();
                                      _b.label = 2;
                                  case 2:
                                      _b.trys.push( [ 2, 4, , 5 ] );
                                      return [ 4, new Promise( function ( resolve, reject ) {
                                          oClipboardJS.on( 'success', resolve );
                                          oClipboardJS.on( 'error', reject );
                                  ...
                                  case 4:
                                      ...
                                      return [ 3, 5 ];
                                  case 5:
                                      oBodyElement.removeChild( oButtonElement );
                                      oClipboardJS.destroy();
                                      return [ 2, isStatus ];
                              }
                          } );
                      } );
                  ...
                  Bridge.prototype.onInitial = function ( iOnly ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, oObject, sUnpkg_1, _a, _b;
                          var _this = this;
                          return __generator( this, function ( _c ) {
                              switch ( _c.label ) {
                                  case 0:
                                  ...
                                  case 1:
                                      _c.trys.push( [ 1, 6, , 7 ] );
                                      sUnpkg_1 = "https://cdnjs.cloudflare.com/ajax/libs/clipboard.js/2.0.11/clipboard.min.js";
                                      _c.label = 2;
                                  case 2:
                                      _c.trys.push( [ 2, 4, , 5 ] );
                                      return [ 4, new Promise( function ( resolve, reject ) {
                                          return _this.onLoad( "Id".concat( sOnly ), sUnpkg_1, resolve, reject );
                                      } ) ];
                                  case 3:
                                      _c.sent();
                                      return [ 3, 5 ];
                  ...
                  Bridge.prototype.onVisibility = function ( iOnly, iName, iMethod ) {
                      var sOnly = UTF8ToString( iOnly );
                      var sName = UTF8ToString( iName );
                      var sMethod = UTF8ToString( iMethod );
                      var oObject;
                      try {
                          document.addEventListener( "visibilitychange", function () {
                              ...
                              SendMessage( sName, sMethod, oValue );
                          } );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                          ...
                          oObject = {
                              Only: sOnly,
                              Type: "Failure",
                              Value: typeof error == "string" ? error : error instanceof Error ? error.message : JSON.stringify( error )
                          };
                      }
                      this.onReply( oObject );
                  };
                  Bridge.prototype.onClipboard = function ( iOnly, iValue, iTips ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, sValue, sTips, oObject, _a, _b;
                          return __generator( this, function ( _c ) {
                              switch ( _c.label ) {
                                  case 0:
                                      sOnly = UTF8ToString( iOnly );
                                      sValue = UTF8ToString( iValue );
                                      sTips = UTF8ToString( iTips );
                                      return [ 4, this.onAwait() ];
                                  case 1:
                                      _c.sent();
                                      _b = this._version >= 2022 || !/iPhone|iPad|iPod|Mac/i.test( navigator.userAgent );
                                      if ( _b ) return [ 3, 3 ];
                                      return [ 4, this.onShowConfirm( sTips ) ];
                                  case 2:
                                      _b = ( _c.sent() );
                                      _c.label = 3;
                                  case 3:
                                      _a = ( _b );
                                      if ( !_a ) return [ 3, 5 ];
                                      return [ 4, this.clipboard( sValue ) ];
                                  case 4:
                                      _a = ( _c.sent() );
                                      _c.label = 5;
                                  case 5:
                  ...
                  Bridge.prototype.onPrompt = function ( iOnly, iTitle, iValue ) {
                      var sOnly = UTF8ToString( iOnly );
                      var sTitle = UTF8ToString( iTitle );
                      var sValue = UTF8ToString( iValue );
                      var oObject;
                      try {
                          var sContent = prompt( sTitle, sValue );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: sContent ? sContent : sValue
                          };
                      } catch ( error ) {
                          oObject = {
                              Only: sOnly,
                  ...
                  Bridge.prototype.onLanguage = function ( iOnly ) {
                      var sOnly = UTF8ToString( iOnly );
                      var oObject;
                      try {
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: ( Reflect.get( window.navigator, "language" ) || Reflect.get( window.navigator, "userLanguage" ) || Reflect.get( window.navigator, "browserLanguage" ) || Reflect.get( window.navigator, "systemLanguage" ) ).toLowerCase()
                          };
                      } catch ( error ) {
                          oObject = {
                              Only: sOnly,
                  ...
                  Bridge.prototype.onInput = function ( iOnly, iValue, iType ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, sValue, oObject, sContent, sType, oBodyElement, oHTMLFormElement_1, oMaskHTMLDivElement, oHTMLInputElement_1, error_1;
                          var _a;
                          var _this = this;
                          return __generator( this, function ( _b ) {
                              switch ( _b.label ) {
                                  case 0:
                                      sOnly = UTF8ToString( iOnly );
                                      sValue = UTF8ToString( iValue );
                                      if ( !/iPhone|iPad|iPod|Mac/i.test( navigator.userAgent ) ) return [ 3, 1 ];
                                      try {
                                          sContent = prompt( "", sValue );
                                          oObject = {
                                              Only: sOnly,
                                              Type: "Success",
                                              Value: sContent ? sContent : sValue
                                      ...
                                      return [ 3, 7 ];
                                  case 1:
                                      sType = UTF8ToString( iType );
                                      oBodyElement = document.querySelector( "body" );
                                      oHTMLFormElement_1 = document.createElement( "form" );
                                      oHTMLFormElement_1.style.position = "fixed";
                                      oHTMLFormElement_1.style.top = "0";
                                      oHTMLFormElement_1.style.left = "0";
                                      oHTMLFormElement_1.style.bottom = "0";
                                      oHTMLFormElement_1.style.right = "0";
                                      oHTMLFormElement_1.style.zIndex = "1000";
                                      oMaskHTMLDivElement = document.createElement( "div" );
                                      oMaskHTMLDivElement.style.backgroundColor = "#00000054";
                                      oMaskHTMLDivElement.style.position = "absolute";
                                      oMaskHTMLDivElement.style.top = "0";
                                      oMaskHTMLDivElement.style.left = "0";
                                      oMaskHTMLDivElement.style.bottom = "0";
                                      oMaskHTMLDivElement.style.right = "0";
                                      oHTMLFormElement_1.appendChild( oMaskHTMLDivElement );
                                      oHTMLInputElement_1 = document.createElement( "input" );
                                      oHTMLInputElement_1.value = sValue;
                                      oHTMLInputElement_1.type = sType;
                                      oHTMLInputElement_1.style.position = "absolute";
                                      oHTMLInputElement_1.style.display = "block";
                                      oHTMLInputElement_1.style.left = "0";
                                      oHTMLInputElement_1.style.right = "0";
                                      oHTMLInputElement_1.style.bottom = "0";
                                      oHTMLInputElement_1.style.height = "10vw";
                                      oHTMLFormElement_1.appendChild( oHTMLInputElement_1 );
                                      return [ 4, this.onAwait() ];
                                  case 2:
                                      _b.sent();
                                      oBodyElement.appendChild( oHTMLFormElement_1 );
                                      _b.label = 3;
                                  case 3:
                                      _b.trys.push( [ 3, 5, , 6 ] );
                                      _a = {
                                      ...
                                      return [ 4, new Promise( function ( resolve, reject ) {
                                          return _this.onEvent( oHTMLFormElement_1, oHTMLInputElement_1, sValue, resolve, reject );
                                      } ) ];
                                  case 4:
                                      oObject = ( _a.Value = _b.sent(),
                                          _a );
                                      return [ 3, 6 ];
                                  case 5:
                                      error_1 = _b.sent();
                                      oObject = {
                                          Only: sOnly,
                                          Type: "Failure",
                                          Value: typeof error_1 == "string" ? error_1 : error_1 instanceof Error ? error_1.message : JSON.stringify( error_1 )
                                      };
                                      return [ 3, 6 ];
                                  case 6:
                                      oBodyElement.removeChild( oHTMLFormElement_1 );
                                      _b.label = 7;
                                  case 7:
                                      this.onReply( oObject );
                                      return [ 2 ];
                  ...
                  Bridge.prototype.onEvent = function ( oHTMLFormElement, oHTMLInputElement, sValue, resolve, reject ) {
                      oHTMLFormElement.addEventListener( "submit", function ( oSubmitEvent ) {
                          oSubmitEvent.preventDefault();
                          oHTMLInputElement.blur();
                          return false;
                      } );
                      oHTMLInputElement.addEventListener( "blur", function () {
                          return oHTMLInputElement.value == sValue ? reject() : resolve( oHTMLInputElement.value );
                      } );
                      setTimeout( function () {
                          return oHTMLInputElement.focus();
                      }, 100 );
                  };
                  return Bridge;
              }() );
              Reflect.set( window, "#unity.bridge.system", new Bridge( iOnly, iName, iMethod, iVersion ) );
          }
      }

  function _onSystemInput( iOnly, iValue, iType ) {
          Reflect.get( window, "#unity.bridge.system" ).onInput( iOnly, iValue, iType );
      }

  function _onSystemLanguage( iOnly ) {
          Reflect.get( window, "#unity.bridge.system" ).onLanguage( iOnly );
      }

  function _onSystemPrompt( iOnly, iTitle, iValue ) {
          Reflect.get( window, "#unity.bridge.system" ).onPrompt( iOnly, iTitle, iValue );
      }

  function _onSystemVisibility( iOnly, iName, iMethod ) {
          Reflect.get( window, "#unity.bridge.system" ).onVisibility( iOnly, iName, iMethod );
      }

  function _onTelegramDisableClosingConfirmation( iOnly ) {
          Reflect.get( window, "#unity.bridge.telegram" ).onDisableClosingConfirmation( iOnly );
      }

  function _onTelegramEnableClosingConfirmation( iOnly ) {
          Reflect.get( window, "#unity.bridge.telegram" ).onEnableClosingConfirmation( iOnly );
      }

  function _onTelegramExpand( iOnly ) {
          Reflect.get( window, "#unity.bridge.telegram" ).onExpand( iOnly );
      }

  function _onTelegramInitData( iOnly ) {
          Reflect.get( window, "#unity.bridge.telegram" ).onInitData( iOnly );
      }

  function _onTelegramInitial( iOnly, iName, iMethod, iUnpkg ) {
          if ( Reflect.has( window, "#unity.bridge.telegram" ) ) {
              var oObject = {
                  Only: UTF8ToString( iOnly ),
                  Type: "Failure",
                  Value: "Telegram has been initial"
              };
              SendMessage( UTF8ToString( iName ), UTF8ToString( iMethod ), JSON.stringify( {
                  Key: Object.keys( oObject ),
                  Value: Object.values( oObject )
              ...
              var Bridge = ( function () {
                  ...
                  Object.defineProperty( Bridge.prototype, "_telegram", {
                      get: function () {
                          return Reflect.get( window, "Telegram" );
                      },
                      enumerable: false,
                      configurable: true
                  } );
                  Object.defineProperty( Bridge.prototype, "_webApp", {
                      get: function () {
                          return Reflect.get( this._telegram, "WebApp" );
                      },
                      enumerable: false,
                      configurable: true
                  } );
                  Object.defineProperty( Bridge.prototype, "_initDataUnsafe", {
                      get: function () {
                          return Reflect.get( this._webApp, "initDataUnsafe" );
                      },
                      enumerable: false,
                      configurable: true
                  } );
                  Object.defineProperty( Bridge.prototype, "_user", {
                      get: function () {
                          var _this = this;
                          var oObject = Reflect.get( this._initDataUnsafe, "user" );
                          var aKey = Object.keys( oObject );
                          var aValue = Object.values( oObject );
                          return JSON.stringify( {
                              Length: aKey.length,
                              Key: btoa( aKey.map( function ( t ) {
                                  return btoa( t );
                              } ).join( "," ) ),
                              Value: btoa( aValue.map( function ( t ) {
                                  return btoa( String.fromCharCode.apply( String, __spreadArray( [], __read( _this._encoder.encode( t ) ), false ) ) );
                              } ).join( "," ) ),
                          } );
                      },
                  ...
                  Object.defineProperty( Bridge.prototype, "_receiver", {
                      get: function () {
                          var _this = this;
                          var oObject = Reflect.get( this._initDataUnsafe, "receiver" );
                          var aKey = Object.keys( oObject );
                          var aValue = Object.values( oObject );
                          return JSON.stringify( {
                              Length: aKey.length,
                  ...
                  Bridge.prototype.openInvoice = function ( sUrl, resolve, reject ) {
                      try {
                          this._webApp.openInvoice( sUrl, resolve );
                      } catch ( error ) {
                          reject( error );
                      }
                  };
                  Bridge.prototype.onInitial = function ( iOnly, iUnpkg ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, sUnpkg, oObject, _a, oHeadElement, oStyleElement, _b;
                          var _this = this;
                          return __generator( this, function ( _c ) {
                              switch ( _c.label ) {
                                  case 0:
                                  ...
                                  case 4:
                                      ...
                                      return [ 3, 5 ];
                                  case 5:
                                      oHeadElement = document.querySelector( "head" );
                                      oStyleElement = document.createElement( "style" );
                                      oStyleElement.textContent = "html { overflow: hidden; } body { width: 100%; height: var(--telegram-vh, 100%); overflow: hidden; padding: 0px; margin: 0px; } #unity-container { width: auto !important; height: auto !important; top: var(--telegram-top, 0px); left: 0px; bottom: 0px; right: 0px; } #tc-widget-root > tc-root > div.s-enter-to { overflow: hidden; }";
                                      oHeadElement.appendChild( oStyleElement );
                                      this._webApp.ready();
                                      Reflect.set( window, "showConfirm", function ( sContent ) {
                                          return new Promise( function ( resolve ) {
                                              return _this._webApp.showConfirm( sContent, resolve );
                                          } );
                                      } );
                                      oObject = {
                                          Only: sOnly,
                                  ...
                                  case 8:
                                      this.onScrollTo();
                                      return [ 4, new Promise( function ( oResolve ) {
                                          return setTimeout( oResolve, 1000 );
                                      } ) ];
                                  case 9:
                                      _c.sent();
                                      _c.label = 10;
                  ...
                  Bridge.prototype.onInitData = function ( iOnly ) {
                      var sOnly = UTF8ToString( iOnly );
                      var oObject;
                      try {
                          oObject = {
                  ...
                  Bridge.prototype.onStartApp = function ( iOnly ) {
                      var sOnly = UTF8ToString( iOnly );
                      var oObject;
                      try {
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: this._webApp.initDataUnsafe.start_param
                          };
                      } catch ( error ) {
                          oObject = {
                              Only: sOnly,
                  ...
                  Bridge.prototype.onUser = function ( iOnly ) {
                      var sOnly = UTF8ToString( iOnly );
                      var oObject;
                      try {
                          if ( Reflect.has( this._webApp, "initDataUnsafe" ) && Reflect.has( this._initDataUnsafe, "user" ) ) {
                              oObject = {
                                  Only: sOnly,
                                  Type: "Success",
                                  Value: this._user
                  ...
                  Bridge.prototype.onReceiver = function ( iOnly ) {
                      var sOnly = UTF8ToString( iOnly );
                      var oObject;
                      try {
                          if ( Reflect.has( this._webApp, "initDataUnsafe" ) && Reflect.has( this._initDataUnsafe, "receiver" ) ) {
                              oObject = {
                                  Only: sOnly,
                                  Type: "Success",
                  ...
                  Bridge.prototype.onExpand = function ( iOnly ) {
                      var sOnly = UTF8ToString( iOnly );
                      var oObject;
                      try {
                          this._webApp.expand();
                  ...
                  Bridge.prototype.onEnableClosingConfirmation = function ( iOnly ) {
                      var sOnly = UTF8ToString( iOnly );
                      var oObject;
                      try {
                  ...
                  Bridge.prototype.onDisableClosingConfirmation = function ( iOnly ) {
                      var sOnly = UTF8ToString( iOnly );
                      var oObject;
                      try {
                          this._webApp.onDisableClosingConfirmation();
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: ""
                  ...
                  Bridge.prototype.onOpenLink = function ( iOnly, iUrl, isTryInstantView ) {
                      var sOnly = UTF8ToString( iOnly );
                      var sUrl = UTF8ToString( iUrl );
                      var oObject;
                      try {
                          this._webApp.openLink( sUrl, {
                              try_instant_view: isTryInstantView
                          } );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                  ...
                  Bridge.prototype.onOpenTelegramLink = function ( iOnly, iUrl ) {
                      var sOnly = UTF8ToString( iOnly );
                      var sUrl = UTF8ToString( iUrl );
                      var oObject;
                      try {
                          this._webApp.openTelegramLink( sUrl );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: ""
                  ...
                  Bridge.prototype.onOpenInvoice = function ( iOnly, iUrl ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, sUrl, oObject, sValue, error_1;
                          var _this = this;
                          return __generator( this, function ( _a ) {
                              switch ( _a.label ) {
                                  case 0:
                                      sOnly = UTF8ToString( iOnly );
                                      sUrl = UTF8ToString( iUrl );
                                      _a.label = 1;
                                  case 1:
                                      _a.trys.push( [ 1, 3, , 4 ] );
                                      return [ 4, new Promise( function ( resolve, reject ) {
                                          return _this.openInvoice( sUrl, resolve, reject );
                                      } ) ];
                                  case 2:
                                      sValue = _a.sent();
                                      oObject = {
                  ...
                  Bridge.prototype.onPlatform = function ( iOnly ) {
                      var sOnly = UTF8ToString( iOnly );
                      var oObject;
                      try {
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: Reflect.get( this._webApp, "platform" )
                          };
                      } catch ( error ) {
                          oObject = {
                              Only: sOnly,
                  ...
                  Bridge.prototype.onScrollTo = function () {
                      var iTop = 0;
                      if ( /iPhone|iPad|iPod/i.test( navigator.userAgent ) ) {
                          window.scrollTo( {
                              top: ( document.documentElement.scrollHeight || document.body.scrollHeight ) * 2,
                              behavior: "smooth"
                          } );
                          iTop = Math.max( ( document.documentElement.scrollHeight || document.body.scrollHeight ) - window.innerHeight, iTop );
                          document.documentElement.style.setProperty( "--telegram-vh", "".concat( window.innerHeight, "px" ) );
                          document.documentElement.style.setProperty( "--telegram-top", "".concat( iTop, "px" ) );
                      } else {
                          window.scrollTo( {
                              top: ( document.documentElement.scrollHeight || document.body.scrollHeight ) * 2,
                              behavior: "smooth"
                          } );
                          document.documentElement.style.setProperty( "--telegram-vh", "".concat( window.innerHeight * 2, "px" ) );
                          document.documentElement.style.setProperty( "--telegram-top", "".concat( iTop, "px" ) );
                      }
                  };
                  return Bridge;
              }() );
              Reflect.set( window, "#unity.bridge.telegram", new Bridge( iOnly, iName, iMethod, iUnpkg ) );
          }
      }

  function _onTelegramOpenInvoice( iOnly, iUrl ) {
          Reflect.get( window, "#unity.bridge.telegram" ).onOpenInvoice( iOnly, iUrl );
      }

  function _onTelegramOpenLink( iOnly, iUrl, isTryInstantView ) {
          Reflect.get( window, "#unity.bridge.telegram" ).onOpenLink( iOnly, iUrl, isTryInstantView );
      }

  function _onTelegramOpenTelegramLink( iOnly, iUrl ) {
          Reflect.get( window, "#unity.bridge.telegram" ).onOpenTelegramLink( iOnly, iUrl );
      }

  function _onTelegramPlatform( iOnly ) {
          Reflect.get( window, "#unity.bridge.telegram" ).onPlatform( iOnly );
      }

  function _onTelegramStartApp( iOnly ) {
          Reflect.get( window, "#unity.bridge.telegram" ).onStartApp( iOnly );
      }

  function _onTelegramUser( iOnly ) {
          Reflect.get( window, "#unity.bridge.telegram" ).onUser( iOnly );
      }

  function _onThinkingInitial( iOnly, iName, iMethod, iScript, iAppId, iServerUrl, isPageShow, isPageHide ) {
          if ( Reflect.has( window, "#unity.bridge.thinking" ) ) {
              var oObject = {
                  Only: UTF8ToString( iOnly ),
                  Type: "Failure",
                  Value: "Thinking has been initial"
              };
              SendMessage( UTF8ToString( iName ), UTF8ToString( iMethod ), JSON.stringify( {
                  Key: Object.keys( oObject ),
                  Value: Object.values( oObject )
              ...
              var Bridge = ( function () {
                  function Bridge ( iOnly, iName, iMethod, iScript, iAppId, iServerUrl, isPageShow, isPageHide ) {
                      this._encoder = new TextEncoder();
                      this._decoder = new TextDecoder();
                      this._name = UTF8ToString( iName );
                      this._method = UTF8ToString( iMethod );
                      this.onInitial( iOnly, iScript, iAppId, iServerUrl, isPageShow, isPageHide );
                  }
                  Object.defineProperty( Bridge.prototype, "_thinkingdata", {
                      get: function () {
                          return Reflect.get( window, "thinkingdata" );
                      },
                      enumerable: false,
                      configurable: true
                  } );
                  ...
                  Bridge.prototype.forEach = function ( iLength ) {
                      var iIndex;
                      return __generator( this, function ( _a ) {
                          switch ( _a.label ) {
                              case 0:
                  ...
                  Bridge.prototype.decode = function ( sValue ) {
                      var oUint8Array = new Uint8Array( sValue.length );
                      var oIterator = this.forEach( sValue.length );
                      do {
                          var _a = oIterator.next(),
                              done = _a.done,
                              value = _a.value;
                          if ( done ) {
                              oIterator = null;
                          } else {
                              oUint8Array[ value ] = sValue.charCodeAt( value );
                          }
                      } while ( oIterator );
                      return this._decoder.decode( oUint8Array );
                  };
                  Bridge.prototype.value = function ( sValue ) {
                      var oValue = JSON.parse( atob( sValue ) );
                      var oObject = new Object();
                      var aKey = oValue.Key.split( "," ).map( function ( t2 ) {
                          return atob( t2 );
                      } );
                      var aValue = oValue.Value.split( "," ).map( function ( t2 ) {
                          return atob( t2 );
                      } );
                      var oIterator = this.forEach( oValue.Length );
                      do {
                          var _a = oIterator.next(),
                              done = _a.done,
                              value = _a.value;
                          if ( done ) {
                              ...
                              Reflect.set( oObject, aKey[ value ], this.decode( aValue[ value ] ) );
                          }
                      } while ( oIterator );
                      return oObject;
                  };
                  Bridge.prototype.onLoad = function ( sScript, resolve, reject ) {
                      var oHeadElement = document.querySelector( "head" );
                      var oScriptElement = document.createElement( "script" );
                      ...
                      oHeadElement.appendChild( oScriptElement );
                      oScriptElement.dispatchEvent( new Event( sScript ? 'load' : 'error' ) );
                  };
                  Bridge.prototype.onInitial = function ( iOnly, iScript, iAppId, iServerUrl, isPageShow, isPageHide ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, sScript, sAppId, sServerUrl, oObject, _a;
                          var _this = this;
                          return __generator( this, function ( _b ) {
                              switch ( _b.label ) {
                                  case 0:
                                      sOnly = UTF8ToString( iOnly );
                                      sScript = UTF8ToString( iScript );
                                      sAppId = UTF8ToString( iAppId );
                                      sServerUrl = UTF8ToString( iServerUrl );
                                      _b.label = 1;
                                  case 1:
                                      _b.trys.push( [ 1, 3, , 4 ] );
                                      return [ 4, new Promise( function ( resolve, reject ) {
                                          return _this.onLoad( sScript, resolve, reject );
                                      } ) ];
                                  case 2:
                                      _b.sent();
                                      this._thinkingdata.init( {
                                          appId: sAppId,
                                  ...
                                  case 3:
                                      ...
                                      oObject = {
                                          Only: sOnly,
                                          Type: "Failure",
                                          Value: "thinkingdata has been initial"
                                      };
                                      return [ 3, 4 ];
                                  case 4:
                                      this.onReply( oObject );
                  ...
                  Bridge.prototype.onInitInstance = function ( iOnly, iName, iParam ) {
                      var sOnly = UTF8ToString( iOnly );
                      var sName = UTF8ToString( iName );
                      var sParam = UTF8ToString( iParam );
                      var oObject;
                      if ( this._thinkingdata ) {
                          this._thinkingdata.initInstance( sName, this.value( sParam ) );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: "Execute initInstance successfully"
                          };
                      } else {
                          oObject = {
                              Only: sOnly,
                              Type: "Failure",
                              Value: "Failed to execute initInstance"
                          };
                      }
                      this.onReply( oObject );
                  };
                  Bridge.prototype.onLogin = function ( iOnly, iAccountId ) {
                      var sOnly = UTF8ToString( iOnly );
                      var sAccountId = UTF8ToString( iAccountId );
                      var oObject;
                      if ( this._thinkingdata ) {
                          this._thinkingdata.login( sAccountId );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: "Execute login successfully"
                          };
                      } else {
                          oObject = {
                              Only: sOnly,
                              Type: "Failure",
                              Value: "Failed to execute login"
                          };
                      }
                      this.onReply( oObject );
                  };
                  Bridge.prototype.onSetSuperProperties = function ( iOnly, iParam ) {
                      var sOnly = UTF8ToString( iOnly );
                      var sParam = UTF8ToString( iParam );
                      var oObject;
                      if ( this._thinkingdata ) {
                          this._thinkingdata.setSuperProperties( this.value( sParam ) );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: "Execute setSuperProperties successfully"
                          };
                      } else {
                          oObject = {
                              Only: sOnly,
                              Type: "Failure",
                              Value: "Failed to execute setSuperProperties"
                          };
                      }
                      this.onReply( oObject );
                  };
                  Bridge.prototype.onTrack = function ( iOnly, iEvent, iParam ) {
                      var sOnly = UTF8ToString( iOnly );
                      var sEvent = UTF8ToString( iEvent );
                      var sParam = UTF8ToString( iParam );
                      var oObject;
                      if ( this._thinkingdata ) {
                          if ( sParam == "" ) {
                              this._thinkingdata.track( sEvent );
                          } else {
                              this._thinkingdata.track( sEvent, this.value( sParam ) );
                          }
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: "Execute track successfully"
                          };
                      } else {
                          oObject = {
                              Only: sOnly,
                              Type: "Failure",
                              Value: "Failed to execute track"
                          };
                      }
                      this.onReply( oObject );
                  };
                  Bridge.prototype.onUserSet = function ( iOnly, iParam ) {
                      var sOnly = UTF8ToString( iOnly );
                      var sParam = UTF8ToString( iParam );
                      var oObject;
                      if ( this._thinkingdata ) {
                          this._thinkingdata.userSet( this.value( sParam ) );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: "Execute userSet successfully"
                          };
                      } else {
                          oObject = {
                              Only: sOnly,
                              Type: "Failure",
                              Value: "Failed to execute userSet"
                          };
                      }
                      this.onReply( oObject );
                  };
                  Bridge.prototype.onUserSetOnce = function ( iOnly, iParam ) {
                      var sOnly = UTF8ToString( iOnly );
                      var sParam = UTF8ToString( iParam );
                      var oObject;
                      if ( this._thinkingdata ) {
                          this._thinkingdata.userSetOnce( this.value( sParam ) );
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: "Execute userSetOnce successfully"
                          };
                      } else {
                          oObject = {
                              Only: sOnly,
                              Type: "Failure",
                              Value: "Failed to execute userSetOnce"
                          };
                      }
                      this.onReply( oObject );
                  };
                  Bridge.prototype.onQuick = function ( iOnly, iQuick, iParam ) {
                      var sOnly = UTF8ToString( iOnly );
                      var sQuick = UTF8ToString( iQuick );
                      var sParam = UTF8ToString( iParam );
                      var oObject;
                      if ( this._thinkingdata ) {
                          if ( sParam == "" ) {
                              this._thinkingdata.quick( sQuick );
                          } else {
                              this._thinkingdata.quick( sQuick, this.value( sParam ) );
                          }
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: "Execute quick successfully"
                          };
                      } else {
                          oObject = {
                              Only: sOnly,
                              Type: "Failure",
                              Value: "Failed to execute quick"
                          };
                      }
                      this.onReply( oObject );
                  };
              ...
              Reflect.set( window, "#unity.bridge.thinking", new Bridge( iOnly, iName, iMethod, iScript, iAppId, iServerUrl, isPageShow, isPageHide ) );
          }
      }

  function _onThinkingLogin( iOnly, iAccountId ) {
          Reflect.get( window, "#unity.bridge.thinking" ).onLogin( iOnly, iAccountId );
      }

  function _onThinkingQuick( iOnly, iQuick, iParam ) {
          Reflect.get( window, "#unity.bridge.thinking" ).onQuick( iOnly, iQuick, iParam );
      }

  function _onThinkingTrack( iOnly, iEvent, iParam ) {
          Reflect.get( window, "#unity.bridge.thinking" ).onTrack( iOnly, iEvent, iParam );
      }

  function _onThinkingUserSet( iOnly, iParam ) {
          Reflect.get( window, "#unity.bridge.thinking" ).onUserSet( iOnly, iParam );
      }

  function _onThinkingUserSetOnce( iOnly, iParam ) {
          Reflect.get( window, "#unity.bridge.thinking" ).onUserSetOnce( iOnly, iParam );
      }

  function _onTonAddress1( iOnly ) {
          Reflect.get( window, "#unity.bridge.ton" ).onAddress( iOnly, null );
      }

  function _onTonAddress2( iOnly, iName ) {
          Reflect.get( window, "#unity.bridge.ton" ).onAddress( iOnly, iName );
      }

  function _onTonCurrent( iOnly, iName ) {
          Reflect.get( window, "#unity.bridge.ton" ).onCurrent( iOnly, iName );
      }

  function _onTonDisconnect( iOnly ) {
          Reflect.get( window, "#unity.bridge.ton" ).onDisconnect( iOnly );
      }

  function _onTonInitial( iOnly, iName, iMethod, iUrl, iUnpkg, iManifest ) {
          if ( Reflect.has( window, "#unity.bridge.ton" ) ) {
              var oObject = {
                  Only: UTF8ToString( iOnly ),
                  Type: "Failure",
              ...
              var Bridge = ( function () {
                  function Bridge ( iOnly, iName, iMethod, iUrl, iUnpkg, iManifest ) {
                      this._encoder = new TextEncoder();
                      this._decoder = new TextDecoder();
                      this._name = UTF8ToString( iName );
                      this._method = UTF8ToString( iMethod );
                      this._url = UTF8ToString( iUrl );
                      this._callback = new Array();
                      this.onInitial( iOnly, iUnpkg, iManifest );
                  }
                  Object.defineProperty( Bridge.prototype, "_module", {
                      get: function () {
                          return Reflect.get( window, "TON_CONNECT_UI" );
                      },
                      enumerable: false,
                      configurable: true
                  } );
                  Bridge.prototype.getTonConnectUI = function ( oTonConnectUiCreateOptions ) {
                      return Reflect.construct( Reflect.get( this._module, "TonConnectUI" ), [ oTonConnectUiCreateOptions ] );
                  };
                  Bridge.prototype.onReply = function ( oObject ) {
                      var _this = this;
                      var sJson = JSON.stringify( {
                  ...
                  Bridge.prototype.onStatusChange = function ( oWallet ) {
                      this._wallet = oWallet;
                  };
                  Bridge.prototype.onModalStateChange = function ( oState ) {
                      if ( oState.status == "closed" ) {
                          this.callback();
                      } else {
                          this._wallet = null;
                      }
                  };
                  Bridge.prototype.onSingleWalletModalStateChange = function ( oState ) {
                      if ( oState.status == "closed" ) {
                          this.callback();
                      } else {
                          this._wallet = null;
                  ...
                  Bridge.prototype.toUserFriendlyAddress = function ( sAddress ) {
                      return Reflect.get( this._module, "toUserFriendlyAddress" ).call( this._module, sAddress );
                  };
                  Bridge.prototype.onLoad = function ( sOnly, sUnpkg, resolve, reject ) {
                      var oHeadElement = document.querySelector( "head" );
                      var oScriptElement = document.createElement( "script" );
                  ...
                  Bridge.prototype.onInitial = function ( iOnly, iUnpkg, iManifest ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, sUnpkg, sManifest, oObject, _a, oRegex1, oRegex2, oRegex3, oRegex4, error_1;
                          var _this = this;
                          return __generator( this, function ( _b ) {
                              switch ( _b.label ) {
                                  case 0:
                                      sOnly = UTF8ToString( iOnly );
                                      sUnpkg = UTF8ToString( iUnpkg );
                                      sManifest = UTF8ToString( iManifest );
                                      _b.label = 1;
                                  case 1:
                                      _b.trys.push( [ 1, 7, , 8 ] );
                                      _b.label = 2;
                                  ...
                                  case 5:
                                      ...
                                      oRegex3 = /^http/;
                                      oRegex4 = /^(.{0,})?\/.*$/;
                                      this._connect = this.getTonConnectUI( {
                                          ...
                                          actionsConfiguration: {
                                              twaReturnUrl: "".concat( this._url, "?startapp=address" )
                                          },
                                      } );
                                      this._connect.onStatusChange( this.onStatusChange.bind( this ) );
                                      this._connect.onModalStateChange( this.onModalStateChange.bind( this ) );
                                      this._connect.onSingleWalletModalStateChange( this.onSingleWalletModalStateChange.bind( this ) );
                                      return [ 4, this._connect.connectionRestored ];
                                  case 6:
                                      _b.sent();
                                      oObject = {
                                          Only: sOnly,
                  ...
                  Bridge.prototype.value = function ( oValue ) {
                      var oObject = new Object();
                      var aKey = oValue.Key.split( "," ).map( function ( t2 ) {
                          return atob( t2 );
                      } );
                  ...
                  Bridge.prototype.callback = function () {
                      var aCallback = new Array();
                      this._callback.forEach( function ( t ) {
                          return aCallback.push( t );
                      } );
                      do {
                          if ( aCallback.length ) {
                              var _a = __read( aCallback.pop(), 2 ),
                                  oSuccess = _a[ 0 ],
                                  oFailure = _a[ 1 ];
                              if ( this._wallet ) {
                                  oSuccess.apply( this );
                  ...
                  Bridge.prototype.onAwait = function ( sOnly ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var oObject, _a;
                          var _this = this;
                          return __generator( this, function ( _b ) {
                              switch ( _b.label ) {
                                  case 0:
                                      _b.trys.push( [ 0, 2, , 3 ] );
                                      return [ 4, new Promise( function ( resolve, reject ) {
                                          return _this._callback.push( [ resolve, reject ] );
                                      } ) ];
                                  case 1:
                                      _b.sent();
                                      oObject = {
                                          Only: sOnly,
                                          Type: "Success",
                                          Value: this.toUserFriendlyAddress( this._wallet.account.address )
                                      };
                                      return [ 3, 3 ];
                                  case 2:
                                      _a = _b.sent();
                  ...
                  Bridge.prototype.onStatus = function ( iOnly ) {
                      var sOnly = UTF8ToString( iOnly );
                      var oObject;
                      if ( this._connect ) {
                          oObject = {
                              Only: sOnly,
                              Type: "Success",
                              Value: "".concat( this._connect.connected )
                          };
                      } else {
                          oObject = {
                              Only: sOnly,
                              Type: "Failure",
                              Value: "Tonconnect has not been initial yet"
                          };
                      }
                      this.onReply( oObject );
                  };
                  Bridge.prototype.onCurrent = function ( iOnly, iName ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, sName, oObject;
                          return __generator( this, function ( _a ) {
                              sOnly = UTF8ToString( iOnly );
                              sName = UTF8ToString( iName );
                              if ( this._connect ) {
                                  if ( this._connect.connected && this._wallet ) {
                                      oObject = {
                                          Only: sOnly,
                                          Type: "Success",
                                          Value: this._wallet.name == sName || this._wallet.appName == sName
                                      };
                                  } else {
                                      oObject = {
                                          Only: sOnly,
                  ...
                  Bridge.prototype.onAddress = function ( iOnly, iName ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, oObject, sName_1, aWallets, oWalletInfo, oDivElement, oDivElement, error_2;
                          return __generator( this, function ( _a ) {
                              switch ( _a.label ) {
                                  case 0:
                                      sOnly = UTF8ToString( iOnly );
                                  ...
                                  case 1:
                                      ...
                                      if ( !this._connect ) return [ 3, 14 ];
                                      if ( !iName ) return [ 3, 9 ];
                                      sName_1 = UTF8ToString( iName );
                                      return [ 4, this._connect.getWallets() ];
                                  case 2:
                                      aWallets = _a.sent();
                                      oWalletInfo = aWallets.find( function ( t ) {
                                          return t.name == sName_1 || t.appName == sName_1;
                                      } );
                                      if ( !oWalletInfo ) return [ 3, 7 ];
                                      if ( !( this._connect.connected && this._wallet ) ) return [ 3, 3 ];
                                      if ( this._wallet.name == sName_1 || this._wallet.appName == sName_1 ) {
                                          oObject = {
                                              Only: sOnly,
                                              Type: "Success",
                                              Value: this.toUserFriendlyAddress( this._wallet.account.address )
                                          ...
                                          oObject = {
                                              Only: sOnly,
                                              Type: "Failure",
                                              Value: "Connected to other wallets, please disconnect first"
                                          };
                                      }
                                      return [ 3, 6 ];
                                  case 3:
                                      oDivElement = document.getElementById( "tc-widget-root" );
                                      oDivElement.style.display = "block";
                                      return [ 4, this._connect.openSingleWalletModal( oWalletInfo.appName ) ];
                                  case 4:
                                      _a.sent();
                                      return [ 4, this.onAwait( sOnly ) ];
                                  case 5:
                                      oObject = _a.sent();
                                      _a.label = 6;
                                  case 6:
                                  ...
                                  case 7:
                                      oObject = {
                                          Only: sOnly,
                                          Type: "Failure",
                                          Value: "The linked wallet does not exist"
                                      };
                                      _a.label = 8;
                                  case 8:
                                      return [ 3, 13 ];
                                  case 9:
                                      if ( !( this._connect.connected && this._wallet ) ) return [ 3, 10 ];
                                      oObject = {
                                          Only: sOnly,
                                          Type: "Success",
                                          Value: this.toUserFriendlyAddress( this._wallet.account.address )
                                  ...
                                  case 10:
                                      oDivElement = document.getElementById( "tc-widget-root" );
                                      oDivElement.style.display = "block";
                                      return [ 4, this._connect.openModal() ];
                                  case 11:
                                      _a.sent();
                                      return [ 4, this.onAwait( sOnly ) ];
                                  case 12:
                                  ...
                                  case 16:
                                      ...
                                      oObject = {
                                          Only: sOnly,
                                          Type: "Failure",
                                          Value: typeof error_2 == "string" ? error_2 : error_2 instanceof Error ? error_2.message : JSON.stringify( error_2 )
                                      };
                                      return [ 3, 17 ];
                                  case 17:
                                      this.onReply( oObject );
                  ...
                  Bridge.prototype.onDisconnect = function ( iOnly ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, oObject, error_3;
                          return __generator( this, function ( _a ) {
                              switch ( _a.label ) {
                                  case 0:
                                      sOnly = UTF8ToString( iOnly );
                                      if ( !this._connect ) return [ 3, 7 ];
                                      if ( !this._connect.connected ) return [ 3, 5 ];
                                      _a.label = 1;
                                  case 1:
                                      _a.trys.push( [ 1, 3, , 4 ] );
                                      return [ 4, this._connect.disconnect() ];
                                  case 2:
                                      _a.sent();
                                      oObject = {
                                          Only: sOnly,
                                  ...
                                  case 3:
                                      ...
                                      oObject = {
                                          Only: sOnly,
                                          Type: "Failure",
                                          Value: typeof error_3 == "string" ? error_3 : error_3 instanceof Error ? error_3.message : JSON.stringify( error_3 )
                                      };
                                      return [ 3, 4 ];
                                  case 4:
                                      return [ 3, 6 ];
                                  case 5:
                                      oObject = {
                                          Only: sOnly,
                                          Type: "Failure",
                                          Value: "Tonconnect is not connected and does not need to be disconnected"
                                      };
                                      _a.label = 6;
                                  case 6:
                                      return [ 3, 8 ];
                  ...
                  Bridge.prototype.onTransaction = function ( iOnly, iValidUntil, iValue ) {
                      return __awaiter( this, void 0, void 0, function () {
                          var sOnly, sValue, oObject, oResult, error_4;
                          return __generator( this, function ( _a ) {
                              switch ( _a.label ) {
                                  case 0:
                                      sOnly = UTF8ToString( iOnly );
                                  ...
                                  case 1:
                                      _a.trys.push( [ 1, 3, , 4 ] );
                                      return [ 4, this._connect.sendTransaction( {
                                          validUntil: Math.floor( Date.now() / 1000 ) + iValidUntil,
                                          messages: JSON.parse( atob( sValue ) ).map( this.value.bind( this ) ),
                                      }, {
                                          twaReturnUrl: "".concat( this._url, "?startapp=transaction" )
                                      } ) ];
                                  case 2:
                                      oResult = _a.sent();
                                      oObject = {
                                  ...
                                  case 3:
                                      ...
                                      oObject = {
                                          Only: sOnly,
                                          Type: "Failure",
                                          Value: typeof error_4 == "string" ? error_4 : error_4 instanceof Error ? error_4.message : JSON.stringify( error_4 )
                                      };
                                      return [ 3, 4 ];
                                  case 4:
                                      this.onReply( oObject );
              ...
              Reflect.set( window, "#unity.bridge.ton", new Bridge( iOnly, iName, iMethod, iUrl, iUnpkg, iManifest ) );
          }
      }

  function _onTonStatus( iOnly ) {
          Reflect.get( window, "#unity.bridge.ton" ).onStatus( iOnly );
      }

  function _onTonTransaction( iOnly, iValidUntil, iValue ) {
          Reflect.get( window, "#unity.bridge.ton" ).onTransaction( iOnly, iValidUntil, iValue );
      }
...
var asmLibraryArg = {
  ...
  "onAdsgramBannerNotFound": _onAdsgramBannerNotFound,
  "onAdsgramError": _onAdsgramError,
  "onAdsgramInitial": _onAdsgramInitial,
  "onAdsgramReward": _onAdsgramReward,
  "onAdsgramShow": _onAdsgramShow,
  "onAdsgramSkip": _onAdsgramSkip,
  "onAdsgramStart": _onAdsgramStart,
  "onAnalyticsInit": _onAnalyticsInit,
  "onAnalyticsInitial": _onAnalyticsInitial,
  "onSystemClipboard": _onSystemClipboard,
  "onSystemInitial": _onSystemInitial,
  "onSystemInput": _onSystemInput,
  "onSystemLanguage": _onSystemLanguage,
  "onSystemPrompt": _onSystemPrompt,
  "onSystemVisibility": _onSystemVisibility,
  "onTelegramDisableClosingConfirmation": _onTelegramDisableClosingConfirmation,
  "onTelegramEnableClosingConfirmation": _onTelegramEnableClosingConfirmation,
  "onTelegramExpand": _onTelegramExpand,
  "onTelegramInitData": _onTelegramInitData,
  "onTelegramInitial": _onTelegramInitial,
  "onTelegramOpenInvoice": _onTelegramOpenInvoice,
  "onTelegramOpenLink": _onTelegramOpenLink,
  "onTelegramOpenTelegramLink": _onTelegramOpenTelegramLink,
  "onTelegramPlatform": _onTelegramPlatform,
  "onTelegramStartApp": _onTelegramStartApp,
  "onTelegramUser": _onTelegramUser,
  "onThinkingInitial": _onThinkingInitial,
  "onThinkingLogin": _onThinkingLogin,
  "onThinkingQuick": _onThinkingQuick,
  "onThinkingTrack": _onThinkingTrack,
  "onThinkingUserSet": _onThinkingUserSet,
  "onThinkingUserSetOnce": _onThinkingUserSetOnce,
  "onTonAddress1": _onTonAddress1,
  "onTonAddress2": _onTonAddress2,
  "onTonCurrent": _onTonCurrent,
  "onTonDisconnect": _onTonDisconnect,
  "onTonInitial": _onTonInitial,
  "onTonStatus": _onTonStatus,
  "onTonTransaction": _onTonTransaction,

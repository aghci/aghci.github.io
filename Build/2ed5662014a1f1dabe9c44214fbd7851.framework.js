...
var ASM_CONSTS = {
 ...
 4152270: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  function _onTelegramDisableClosingConfirmation( iOnly ) {
          ...
          let oObject;
          try {
              if ( Telegram.WebApp.isVersionAtLeast( "6.2+" ) ) {
                  ...
                  oObject = {
                      Only: sOnly,
                      Type: "Failure",
                      Value: window.integration_telegram.version
                  };
              }
          } catch ( error ) {
              oObject = {
  ...
  function _onTelegramInitial( iOnly, iName, iMethod, iUnpkg ) {
          ...
          if ( window.integration_telegram ) {
              ...
              window.integration_telegram = {
                  name: sName,
                  method: sMethod,
                  version: "To complete this action, please update your Telegram application to the latest version."
              };
              let oHeadElement = document.querySelector( "head" );
              let oScriptElement = document.createElement( "script" );
              oScriptElement.src = sUnpkg;
              oScriptElement.onload = () => SendMessage( window.integration_telegram.name, window.integration_telegram.method, JSON.stringify( {
                  Only: sOnly,
                  Type: "Success",
                  Value: ""
              } ) );

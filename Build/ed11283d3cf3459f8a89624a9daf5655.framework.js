...
var ASM_CONSTS = {
  4152432: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4152493: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4152557: function() {return Module.webglContextAttributes.powerPreference;},  
 4152615: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4152670: function($0) {performance.now = function() { return $0; };},  
 4152718: function($0) {performance.now = function() { return $0; };},  
 4152766: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  async function _onSystemGetClipboard( iOnly ) {
          ...
          oBodyElement.appendChild( oInputElement );
          oBodyElement.appendChild( oButtonElement );
          let oClipboardJS = new ClipboardJS( "#clipboard", { target: () => oInputElement } );
          oClipboardJS.on( 'success', () => SendMessage( window.integration_system.name, window.integration_system.method, JSON.stringify( {
              Only: sOnly,
              Type: "Success",
              Value: oInputElement.value
          } ) ) );
          oClipboardJS.on( 'error', ( error ) => SendMessage( window.integration_system.name, window.integration_system.method, JSON.stringify( {
              Only: sOnly,
              Type: "Failure",
...
var asmLibraryArg = {
  ...
  "onSystemGetClipboard": _onSystemGetClipboard,

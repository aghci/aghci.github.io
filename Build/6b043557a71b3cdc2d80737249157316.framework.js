...
var ASM_CONSTS = {
 ...
 4152270: function() {performance.now = Module['emscripten_get_now_backup'];}
  ...
  function _onTonInitial( iOnly, iName, iMethod, iUnpkg, iManifest ) {
          ...
          let sName = UTF8ToString( iName );
          let sMethod = UTF8ToString( iMethod );
          let sTwaReturnUrl = "https://t.me/AghciBot/goodapp?startapp=r_3_22424091";
          let sUnpkg = UTF8ToString( iUnpkg );
          ...
          if ( window.integration_ton ) {
              ...
              oScriptElement.onload = () => {
                  ...
                  window.integration_ton.ui = new TON_CONNECT_UI.TonConnectUI( {
                      ...
                      actionsConfiguration: { twaReturnUrl: sTwaReturnUrl }
                  } );
  ...
  async function _onTonTransaction( iOnly, iValidUntil, iValue ) {
          ...
          let oObject;
          try {
              window.integration_ton.ui.sendTransaction( {

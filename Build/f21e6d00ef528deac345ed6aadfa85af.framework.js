  ...
  function _onSystemInitial( iOnly, iName, iMethod ) {
          ...
          if ( window.integration_system ) {
                  ...
                  clipboard: async ( sValue ) => {
                      ...
                      try {
                          await new Promise( ( resolve, reject ) => {
                              ...
                              window.integration_system.click.push( {
                                  callback: oButtonElement.click,
                                  object: oButtonElement
                              } );
                          } );
                          isStatus = true;
                      } catch {
              ...
              document.addEventListener( "click", () => {
                  console.log( "OnCopy 2" );
                  let aEvent = [];
                  window.integration_system.click.forEach( t => aEvent.push( t ) );
                  window.integration_system.click.length = 0;
                  do {
                      if ( aEvent.length ) {
                          let oValue = aEvent.pop();
                          oValue.callback.call( oValue.object );
                      } else {
                          aEvent = null;
                      }
                  } while ( aEvent );

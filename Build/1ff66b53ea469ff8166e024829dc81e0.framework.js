...
var ASM_CONSTS = {
  4156208: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 4156269: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 4156333: function() {return Module.webglContextAttributes.powerPreference;},  
 4156391: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 4156446: function($0) {performance.now = function() { return $0; };},  
 4156494: function($0) {performance.now = function() { return $0; };},  
 4156542: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _onThinkingTrack( iOnly, iEvent, iParam ) {
          ...
          if ( window.integration_thinking.ta ) {
              if ( sParam != "" ) {
                  ...
                  window.integration_thinking.ta.track( sEvent, JSON.stringify( sParam ) );
              }
              oObject = {
                  Only: sOnly,
                  Type: "Success",
  ...
  function _onThinkingUserSet( iOnly, iParam ) {
          ...
          let oObject;
          if ( window.integration_thinking.ta ) {
              window.integration_thinking.ta.userSet( JSON.stringify( sParam ) );
              oObject = {
                  Only: sOnly,
                  Type: "Success",
  ...
  function _onThinkingUserSetOnce( iOnly, iParam ) {
          ...
          let oObject;
          if ( window.integration_thinking.ta ) {
              window.integration_thinking.ta.userSetOnce( JSON.stringify( sParam ) );
              oObject = {
                  Only: sOnly,
                  Type: "Success",

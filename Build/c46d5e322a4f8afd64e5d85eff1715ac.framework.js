  ...
  async function _onSystemClipboard( iOnly, iValue ) {
          ...
          try {
              if ( sValue == "" ) {
                  ...
                  window.integration_system.clipboard2( sValue ) || window.integration_system.clipboard3( sValue ) || await window.integration_system.clipboard1( sValue ) || await navigator.clipboard.writeText( sValue );
                  oObject = {
                      Only: sOnly,
                      Type: "Success",
                      Value: ""
          ...
          if ( window.integration_system ) {
              ...
              window.integration_system = {
                  ...
                  clipboard2: function ( sValue ) {
                      ...
                      oBodyElement.appendChild( oTextareaElement );
                      oTextareaElement.focus();
                      oTextareaElement.select();
                      let isStatus = document.execCommand( 'copy' );
                      setTimeout( () => {
                          oBodyElement.removeChild( oTextareaElement );
                          alert( 2 );
                      }, 5000 );
                      return isStatus;
                  },
                  clipboard3: function ( sValue ) {
                      let oBodyElement = document.querySelector( "body" );
                      ...
                      oBodyElement.appendChild( oSpanElement );
                      ...
                      let isStatus = document.execCommand( 'copy' );
                      setTimeout( () => {
                          oBodyElement.removeChild( oSpanElement );
